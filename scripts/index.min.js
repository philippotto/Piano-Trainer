...
define('vexflow', [], function () {
    ...
    Vex.L = function (e, t) {
        ...
        var r = t + (e - t) / 2;
        return r % 2 > 0 && (r = Vex.RoundN(10 * r, 5) / 10), r;
    }, Vex.SortAndUnique = function (e, t, r) {
        if (e.length > 1) {
            var n, o = [];
            e.sort(t);
            for (var i = 0; i < e.length; ++i)
                0 !== i && r(e[i], n) || o.push(e[i]), n = e[i];
            return o;
        }
        return e;
        ...
        if (!e)
            throw new Vex.RERR('BadArgument', 'Invalid canvas selector: ' + e);
        var t = document.getElementById(e);
        if (!t || !t.getContext)
            throw new Vex.RERR('UnsupportedBrowserError', 'This browser does not support HTML5 Canvas');
        return t.getContext('2d');
    }, Vex.drawDot = function (e, t, r, n) {
        var o = n || '#f55';
        e.save(), e.fillStyle = o, e.beginPath(), e.arc(t, r, 3, 0, 2 * Math.PI, !0), e.closePath(), e.fill(), e.restore();
    }, Vex.BM = function (e, t) {
        ...
        return function (t, r, n) {
            return e.prototype = r.prototype, t.prototype = new e(), t.superclass = r.prototype, t.prototype.constructor = t, Vex.Merge(t.prototype, n), t;
        };
    }();
    Vex.Flow = {
        RESOLUTION: 16384,
    ...
    Vex.Flow.Fraction = function () {
        ...
        return t.GCD = function (t, n) {
            if ('number' != typeof t || 'number' != typeof n)
                throw new Vex.RERR('BadArgument', 'Invalid numbers: ' + t + ', ' + n);
            for (var r; 0 !== n;)
                r = n, n = t % n, t = r;
            return t;
        }, t.LCM = function (n, r) {
            ...
            if (1 == n.length)
                return n[0];
            if (2 == n.length)
                return Vex.Flow.Fraction.LCM(n[0], n[1]);
            var r = n[0];
            ...
            simplify: function () {
                var t = this.numerator, n = this.denominator, r = Vex.Flow.Fraction.GCD(t, n);
            ...
            add: function (t, n) {
                ...
                var i = Vex.Flow.Fraction.LCM(this.denominator, o), e = i / this.denominator, a = i / o, u = this.numerator * e + r * a;
                return this.set(u, i);
            },
            ...
            equals: function (t) {
                var n = Vex.Flow.Fraction.__compareA.copy(t).simplify(), r = Vex.Flow.Fraction.__compareB.copy(this).simplify();
            ...
            toMixedString: function () {
                var t = '', n = this.quotient(), r = Vex.Flow.Fraction.__tmp.copy(this);
            ...
            parse: function (t) {
                var n = t.split('/'), r = parseInt(n[0], 10), o = n[1] ? parseInt(n[1], 10) : 1;
                return this.set(r, o);
            }
        }, t.__compareA = new t(), t.__compareB = new t(), t.__tmp = new t(), t;
    }();
    Vex.Flow.STEM_WIDTH = 1.5, Vex.Flow.STEM_HEIGHT = 32, Vex.Flow.STAVE_LINE_THICKNESS = 2, Vex.Flow.clefProperties = function (e) {
        if (!e)
            throw new Vex.RERR('BadArgument', 'Invalid clef: ' + e);
        ...
        var n = e.split('/');
        if (n.length < 2)
            throw new Vex.RERR('BadArguments', 'Key must have note + octave and an optional glyph: ' + e);
        var i = n[0].toUpperCase(), o = Vex.Flow.keyProperties.note_values[i];
        if (!o)
            throw new Vex.RERR('BadArguments', 'Invalid key name: ' + i);
        o.octave && (n[1] = o.octave);
        var a = n[1], d = 7 * a - 28, _ = (d + o.index) / 2;
        _ += Vex.Flow.clefProperties(t).line_shift;
        var s = 0;
        0 >= _ && 0 === 2 * _ % 2 && (s = 1), _ >= 6 && 0 === 2 * _ % 2 && (s = -1);
        var l = 'undefined' != typeof o.int_val ? 12 * a + o.int_val : null, c = o.code, h = o.shift_right;
        if (n.length > 2 && n[2]) {
            var r = n[2].toUpperCase(), f = Vex.Flow.keyProperties.note_glyph[r];
            f && (c = f.code, h = f.shift_right);
        }
        return {
            key: i,
            octave: a,
        ...
        if (-2 > e)
            throw new Vex.RERR('BadArguments', 'integerToNote requires integer > -2: ' + e);
        var t = Vex.Flow.integerToNote.table[e];
        if (!t)
            throw new Vex.RERR('BadArguments', 'Unknown note value for integer: ' + e);
        return t;
        ...
        var t = null, n = 0, i = 0;
        return 'X' == e.toString().toUpperCase() ? (t = 'v7f', n = 7, i = -4.5) : n = Vex.Flow.textWidth(e.toString()), {
            text: e,
            code: t,
            width: n,
            shift_y: i
        ...
        if (!t)
            throw new Vex.RERR('BadKeySignature', 'Bad key signature spec: \'' + e + '\'');
        if (!t.acc)
            return [];
        for (var n = Vex.Flow.accidentalCodes.accidentals[t.acc].code, i = Vex.Flow.keySignature.accidentalList(t.acc), o = [], a = 0; a < t.num; ++a) {
            var d = i[a];
            o.push({
                glyphCode: n,
                line: d
        ...
        if ('string' != typeof e)
            return null;
        var t = /(\d+|[a-z])(d*)([nrhms]|$)/, n = t.exec(e);
        if (!n)
            return null;
        var i = n[1], o = n[2].length, a = n[3];
        return 0 === a.length && (a = 'n'), {
            duration: i,
            dots: o,
            type: a
        };
    }, Vex.Flow.parseNoteData = function (e) {
        var t = e.duration, n = Vex.Flow.parseNoteDurationString(t);
        if (!n)
            return null;
        var i = Vex.Flow.durationToTicks(n.duration);
        if (null == i)
            return null;
        var o = e.type;
        if (o) {
            if ('n' !== o && 'r' !== o && 'h' !== o && 'm' !== o && 's' !== o)
                return null;
        } else
            o = n.type, o || (o = 'n');
        var a = 0;
        if (a = e.dots ? e.dots : n.dots, 'number' != typeof a)
            return null;
        for (var d = i, _ = 0; a > _; _++) {
            if (1 >= d)
                return null;
            d /= 2, i += d;
        }
        ...
        void 0 !== t && (e = t);
        var n = Vex.Flow.durationToTicks.durations[e];
        ...
        var n = Vex.Flow.durationAliases[e];
        void 0 !== n && (e = n);
        var i = Vex.Flow.durationToGlyph.duration_codes[e];
        if (void 0 === i)
            return null;
        t || (t = 'n');
        var o = i.type[t];
        return void 0 === o ? null : Vex.Merge(Vex.Merge({}, i.common), o);
    ...
    Vex.Flow.renderGlyph = function (t, i, e, s, n, o) {
        var h = 72 * s / (100 * Vex.Flow.Font.resolution), r = Vex.Flow.Glyph.loadMetrics(Vex.Flow.Font, n, !o);
        Vex.Flow.Glyph.renderOutline(t, r.outline, h, i, e);
        ...
        return t.prototype = {
            ...
            render: function (i, e, s) {
                if (!this.metrics)
                    throw new Vex.RuntimeError('BadGlyph', 'Glyph ' + this.code + ' is not initialized.');
                var n = this.metrics.outline, o = this.scale;
                t.renderOutline(i, n, o, e, s);
            },
            renderToStave: function (i) {
                ...
                var e = this.metrics.outline, s = this.scale;
                t.renderOutline(this.context, e, s, i + this.x_shift, this.stave.getYForGlyphs() + this.y_shift);
            }
        }, t.loadMetrics = function (t, i, e) {
            var s = t.glyphs[i];
            if (!s)
                throw new Vex.RuntimeError('BadGlyph', 'Glyph ' + i + ' does not exist in font.');
            var n, o = s.x_min, h = s.x_max, r = s.ha;
            if (s.o)
                return e ? s.cached_outline ? n = s.cached_outline : (n = s.o.split(' '), s.cached_outline = n) : (s.cached_outline && delete s.cached_outline, n = s.o.split(' ')), {
                    x_min: o,
                    x_max: h,
                    ha: r,
                    outline: n
        ...
        }, t.renderOutline = function (t, i, e, s, n) {
            var o = i.length;
            t.beginPath(), t.moveTo(s, n);
            for (var h = 0; o > h;) {
                var r = i[h++];
                switch (r) {
                case 'm':
                    t.moveTo(s + i[h++] * e, n + i[h++] * -e);
                    break;
                case 'l':
                    t.lineTo(s + i[h++] * e, n + i[h++] * -e);
                    break;
                case 'q':
                    var l = s + i[h++] * e, c = n + i[h++] * -e;
                    t.quadraticCurveTo(s + i[h++] * e, n + i[h++] * -e, l, c);
                    break;
                case 'b':
                    var a = s + i[h++] * e, u = n + i[h++] * -e;
                    t.bezierCurveTo(s + i[h++] * e, n + i[h++] * -e, s + i[h++] * e, n + i[h++] * -e, a, u);
                }
            }
            t.fill();
        }, t;
        ...
        return t.prototype = {
            init: function (t, i, e, n) {
                this.x = t, this.y = i, this.width = e, this.glyph_start_x = t + 5, this.glyph_end_x = t + e, this.start_x = this.glyph_start_x, this.end_x = this.glyph_end_x, this.context = null, this.glyphs = [], this.end_glyphs = [], this.modifiers = [], this.measure = 0, this.clef = 'treble', this.font = {
                    ...
                    w: this.width,
                    h: 0
                }, Vex.Merge(this.options, n), this.resetLines(), this.modifiers.push(new Vex.Flow.Barline(Vex.Flow.Barline.type.SINGLE, this.x)), this.modifiers.push(new Vex.Flow.Barline(Vex.Flow.Barline.type.SINGLE, this.x + this.width));
            },
            resetLines: function () {
                this.options.line_config = [];
                for (var t = 0; t < this.options.num_lines; t++)
                    this.options.line_config.push({ visible: !0 });
                this.height = (this.options.num_lines + this.options.space_above_staff_ln) * this.options.spacing_between_lines_px, this.options.bottom_text_position = this.options.num_lines + 1;
            },
            ...
            getNoteStartX: function () {
                var t = this.start_x;
                return this.modifiers[0].barline == Vex.Flow.Barline.type.REPEAT_BEGIN && this.modifiers.length > 2 && (t += 20), t;
            },
            ...
            setWidth: function (t) {
                return this.width = t, this.glyph_end_x = this.x + t, this.end_x = this.glyph_end_x, this.modifiers[1].setX(this.end_x), this;
            },
            getWidth: function () {
                return this.width;
            },
            ...
            setText: function (t, i, e) {
                return this.modifiers.push(new Vex.Flow.StaveText(t, i, e)), this;
            },
            getHeight: function () {
                return this.height;
            },
            ...
            getBottomY: function () {
                var t = this.options, i = t.spacing_between_lines_px, e = this.getYForLine(t.num_lines) + t.space_below_staff_ln * i;
                return e;
            },
            ...
            getYForLine: function (t) {
                var e = this.options, n = e.spacing_between_lines_px, s = e.space_above_staff_ln, o = this.y + (t * n + s * n) - i / 2;
                return o;
            },
            ...
            getYForNote: function (t) {
                var i = this.options, e = i.spacing_between_lines_px, n = i.space_above_staff_ln, s = this.y + n * e + 5 * e - t * e;
                return s;
            },
            ...
            draw: function () {
                ...
                for (var t, i, e = this.options.num_lines, n = this.width, s = this.x, o = 0; e > o; o++)
                    t = this.getYForLine(o), this.context.save(), this.context.setFillStyle(this.options.fill_style), this.context.setStrokeStyle(this.options.fill_style), this.options.line_config[o].visible && this.context.fillRect(s, t, n, Vex.Flow.STAVE_LINE_THICKNESS), this.context.restore();
                s = this.glyph_start_x;
                for (var h = 0; h < this.glyphs.length; ++h)
                    i = this.glyphs[h], i.getContext() || i.setContext(this.context), i.renderToStave(s), s += i.getMetrics().width;
                for (s = this.glyph_end_x, h = 0; h < this.end_glyphs.length; ++h)
                    i = this.end_glyphs[h], i.getContext() || i.setContext(this.context), s -= i.getMetrics().width, i.renderToStave(s);
                for (h = 0; h < this.modifiers.length; h++)
                    'function' == typeof this.modifiers[h].draw && this.modifiers[h].draw(this, this.getModifierXShift());
                if (this.measure > 0) {
            ...
            drawVerticalFixed: function (t, i) {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw stave without canvas context.');
                var e = this.getYForLine(0), n = this.getYForLine(this.options.num_lines - 1);
            ...
            drawVerticalBarFixed: function (t) {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw stave without canvas context.');
                var i = this.getYForLine(0), e = this.getYForLine(this.options.num_lines - 1);
            ...
            setConfigForLines: function (t) {
                ...
                for (var i in t)
                    t[i] || (t[i] = this.options.line_config[i]), Vex.Merge(this.options.line_config[i], t[i]);
    ...
    Vex.Flow.StaveConnector = function () {
        ...
        function e(e, i, s, h, o) {
            if (i !== t.type.BOLD_DOUBLE_LEFT && i !== t.type.BOLD_DOUBLE_RIGHT)
                throw Vex.RERR('InvalidConnector', 'A REPEAT_BEGIN or REPEAT_END type must be provided.');
            var n = 3, _ = 3.5, r = 2;
            i === t.type.BOLD_DOUBLE_RIGHT && (n = -5, _ = 3), e.fillRect(s + n, h, 1, o - h), e.fillRect(s - r, h, _, o - h);
        }
        t.type = {
            SINGLE_RIGHT: 0,
            SINGLE_LEFT: 1,
        ...
        return t.prototype = {
            ...
            setText: function (t, e) {
                return this.text = t, this.text_options = {
                    shift_x: 0,
                    shift_y: 0
                }, Vex.Merge(this.text_options, e), this.font = {
                    family: 'times',
                    size: 16,
                    weight: 'normal'
                }, this;
            ...
            draw: function () {
                ...
                var s = this.top_stave.getYForLine(0), h = this.bottom_stave.getYForLine(this.bottom_stave.getNumLines() - 1) + i, o = this.width, n = this.top_stave.getX(), _ = this.type === t.type.SINGLE_RIGHT || this.type === t.type.BOLD_DOUBLE_RIGHT || this.type === t.type.THIN_DOUBLE;
                _ && (n = this.top_stave.getX() + this.top_stave.width);
                var r = h - s;
                switch (this.type) {
                case t.type.SINGLE:
                    o = 1;
                ...
                case t.type.BRACE:
                    o = 12;
                    var p = this.top_stave.getX() - 2, x = s, a = p, c = h, E = p - o, L = x + r / 2, y = E - 0.9 * o, f = x + 0.2 * r, T = p + 1.1 * o, B = L - 0.135 * r, v = T, R = L + 0.135 * r, D = y, I = c - 0.2 * r, O = E - o, u = I, l = p + 0.4 * o, b = L + 0.135 * r, G = l, w = L - 0.135 * r, N = O, U = f;
                    this.ctx.beginPath(), this.ctx.moveTo(p, x), this.ctx.bezierCurveTo(y, f, T, B, E, L), this.ctx.bezierCurveTo(v, R, D, I, a, c), this.ctx.bezierCurveTo(O, u, l, b, E, L), this.ctx.bezierCurveTo(G, w, N, U, p, x), this.ctx.fill(), this.ctx.stroke();
                    break;
                case t.type.BRACKET:
                    s -= 4, h += 4, r = h - s, Vex.Flow.renderGlyph(this.ctx, n - 5, s - 3, 40, 'v1b', !0), Vex.Flow.renderGlyph(this.ctx, n - 5, h + 3, 40, 'v10', !0), n -= this.width + 2;
                    break;
                case t.type.BOLD_DOUBLE_LEFT:
                    e(this.ctx, this.type, n + this.x_shift, s, h);
                    break;
                case t.type.BOLD_DOUBLE_RIGHT:
                    e(this.ctx, this.type, n, s, h);
                    break;
                case t.type.THIN_DOUBLE:
                    o = 1;
                }
                if (this.type !== t.type.BRACE && this.type !== t.type.BOLD_DOUBLE_LEFT && this.type !== t.type.BOLD_DOUBLE_RIGHT && this.ctx.fillRect(n, s, o, r), this.type === t.type.THIN_DOUBLE && this.ctx.fillRect(n - 3, s, o, r), void 0 !== this.text) {
                    this.ctx.save(), this.ctx.lineWidth = 2, this.ctx.setFont(this.font.family, this.font.size, this.font.weight);
                    var d = this.ctx.measureText('' + this.text).width, m = this.top_stave.getX() - d - 24 + this.text_options.shift_x, H = (this.top_stave.getYForLine(0) + this.bottom_stave.getBottomLineY()) / 2 + this.text_options.shift_y;
                    this.ctx.fillText('' + this.text, m, H + 4), this.ctx.restore();
                }
            }
        }, t;
    }();
    Vex.Flow.TabStave = function () {
        function e(e, t, n, i) {
            arguments.length > 0 && this.init(e, t, n, i);
        }
        return Vex.Inherit(e, Vex.Flow.Stave, {
            init: function (t, n, i, s) {
                ...
                Vex.Merge(a, s), e.superclass.init.call(this, t, n, i, a);
            },
            getYForGlyphs: function () {
            ...
            addTabGlyph: function () {
                ...
                var n = new Vex.Flow.Glyph('v2f', e);
                return n.y_shift = t, this.addGlyph(n), this;
            }
        }), e;
    }();
    Vex.Flow.TickContext = function () {
        ...
        return t.prototype = {
            init: function () {
                this.currentTick = new Vex.Flow.Fraction(0, 1), this.maxTicks = new Vex.Flow.Fraction(0, 1), this.minTicks = null, this.width = 0, this.padding = 3, this.pixelsUsed = 0, this.x = 0, this.tickables = [], this.notePx = 0, this.extraLeftPx = 0, this.extraRightPx = 0, this.ignore_ticks = !0, this.preFormatted = !1, this.postFormatted = !1, this.context = null;
            },
            setContext: function (t) {
                return this.context = t, this;
            },
    ...
    Vex.Flow.Tickable = function () {
        ...
        return t.prototype = {
            init: function () {
                this.intrinsicTicks = 0, this.tickMultiplier = new Vex.Flow.Fraction(1, 1), this.ticks = new Vex.Flow.Fraction(0, 1), this.width = 0, this.x_shift = 0, this.voice = null, this.tickContext = null, this.modifierContext = null, this.modifiers = [], this.preFormatted = !1, this.postFormatted = !1, this.tuplet = null, this.ignore_ticks = !1, this.context = null;
            },
            setContext: function (t) {
                this.context = t;
            },
            ...
            postFormat: function () {
                return this.postFormatted ? void 0 : (this.postFormatted = !0, this);
            },
    ...
    Vex.Flow.Note = function () {
        ...
        return Vex.Inherit(t, Vex.Flow.Tickable, {
            init: function (e) {
                if (t.superclass.init.call(this), !e)
                ...
                if (!i)
                    throw new Vex.RuntimeError('BadArguments', 'Invalid note initialization object: ' + JSON.stringify(e));
                if (this.duration = i.duration, this.dots = i.dots, this.noteType = i.type, this.setIntrinsicTicks(i.ticks), this.modifiers = [], this.glyph = Vex.Flow.durationToGlyph(this.duration, this.noteType), this.positions && ('object' != typeof this.positions || !this.positions.length))
            ...
            getAbsoluteX: function () {
                ...
                return this.stave && (t += this.stave.getNoteStartX() + this.render_options.stave_padding), t;
            },
    ...
    Vex.Flow.NoteHead = function () {
        function t() {
            i.DEBUG && Vex.L('Vex.Flow.NoteHead', arguments);
        }
        function e(t, e, i, s, n) {
            var o = 15 + Vex.Flow.STEM_WIDTH / 2;
            t.setLineWidth(Vex.Flow.STEM_WIDTH);
            var h = !1;
            1 != e && 2 != e && 'h' != e && 'w' != e && (h = !0), h || (i -= Vex.Flow.STEM_WIDTH / 2 * n), t.beginPath(), t.moveTo(i, s + 11), t.lineTo(i, s + 1), t.lineTo(i + o, s - 10), t.lineTo(i + o, s), t.lineTo(i, s + 11), t.closePath(), h ? t.fill() : t.stroke(), t.setLineWidth(1);
        }
        var i = function (t) {
            arguments.length > 0 && this.init(t);
        };
        return Vex.Inherit(i, Vex.Flow.Note, {
            init: function (t) {
                if (i.superclass.init.call(this, t), this.index = t.index, this.x = t.x || 0, this.y = t.y || 0, this.note_type = t.note_type, this.duration = t.duration, this.displaced = t.displaced || !1, this.stem_direction = t.stem_direction || Vex.Flow.StaveNote.STEM_UP, this.line = t.line, this.glyph = Vex.Flow.durationToGlyph(this.duration, this.note_type), !this.glyph)
                    throw new Vex.RuntimeError('BadArguments', 'No glyph found for duration \'' + this.duration + '\' and type \'' + this.note_type + '\'');
                this.glyph_code = this.glyph.code_head, this.x_shift = t.x_shift, t.custom_glyph_code && (this.custom_glyph = !0, this.glyph_code = t.custom_glyph_code), this.context = null, this.style = t.style, this.slashed = t.slashed, Vex.Merge(this.render_options, {
                    glyph_font_scale: 35,
                    stroke_px: 3
                }), t.glyph_font_scale && (this.render_options.glyph_font_scale = t.glyph_font_scale), this.setWidth(this.glyph.head_width);
            },
            ...
            getAbsoluteX: function () {
                var t = i.superclass.getAbsoluteX, e = this.preFormatted ? t.call(this) : this.x;
                return e + (this.displaced ? this.width * this.stem_direction : 0);
            },
            getBoundingBox: function () {
                if (!this.preFormatted)
                    throw new Vex.RERR('UnformattedNote', 'Can\'t call getBoundingBox on an unformatted note.');
                var t = this.stave.getSpacingBetweenLines(), e = t / 2, i = this.y - e;
                return new Vex.Flow.BoundingBox(this.getAbsoluteX(), i, this.width, t);
            },
            applyStyle: function (t) {
                var e = this.getStyle();
                return e.shadowColor && t.setShadowColor(e.shadowColor), e.shadowBlur && t.setShadowBlur(e.shadowBlur), e.fillStyle && t.setFillStyle(e.fillStyle), e.strokeStyle && t.setStrokeStyle(e.strokeStyle), this;
            },
            setStave: function (t) {
                var e = this.getLine();
            ...
            preFormat: function () {
                if (this.preFormatted)
                    return this;
                var t = this.getGlyph(), e = t.head_width + this.extraLeftPx + this.extraRightPx;
                return this.setWidth(e), this.setPreFormatted(!0), this;
            },
            draw: function () {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                var i = this.context, s = this.getAbsoluteX(), n = this.y;
                t('Drawing note head \'', this.note_type, this.duration, '\' at', s, n);
                var o = this.stem_direction, h = this.render_options.glyph_font_scale, r = this.line;
                if (0 >= r || r >= 6) {
                    var l = n, a = Math.floor(r);
                    0 > r && a - r == -0.5 ? l -= 5 : r > 6 && a - r == -0.5 && (l += 5), i.fillRect(s - this.render_options.stroke_px, l, this.getGlyph().head_width + 2 * this.render_options.stroke_px, 1);
                }
                's' == this.note_type ? e(i, this.duration, s, n, o) : this.style ? (i.save(), this.applyStyle(i), Vex.Flow.renderGlyph(i, s, n, h, this.glyph_code), i.restore()) : Vex.Flow.renderGlyph(i, s, n, h, this.glyph_code);
            }
        }), i;
    }();
    Vex.Flow.Stem = function () {
        function t() {
            e.DEBUG && Vex.L('Vex.Flow.Stem', arguments);
        }
        var e = function (t) {
            arguments.length > 0 && this.init(t);
        };
        return e.UP = 1, e.DOWN = -1, e.WIDTH = Vex.Flow.STEM_WIDTH, e.HEIGHT = Vex.Flow.STEM_HEIGHT, e.prototype = {
            init: function (t) {
                this.x_begin = t.x_begin || 0, this.x_end = t.x_end || 0, this.y_top = t.y_top || 0, this.y_bottom = t.y_bottom || 0, this.y_extend = t.y_extend || 0, this.stem_extension = t.stem_extension || 0, this.stem_direction = t.stem_direction || 0, this.hide = !1;
            },
            setNoteHeadXBounds: function (t, e) {
            ...
            getHeight: function () {
                return (this.y_bottom - this.y_top) * this.stem_direction + (e.HEIGHT + this.stem_extension) * this.stem_direction;
            },
            getBoundingBox: function () {
            ...
            getExtents: function () {
                for (var t = [
                            this.y_top,
                            this.y_bottom
                        ], i = this.y_top, n = this.y_bottom, o = e.HEIGHT + this.stem_extension, s = 0; s < t.length; ++s) {
                    var h = t[s] + o * -this.stem_direction;
                    this.stem_direction == e.DOWN ? (i = i > h ? i : h, n = n < t[s] ? n : t[s]) : (i = h > i ? i : h, n = n > t[s] ? n : t[s]);
                }
                return {
                    topY: i,
                    baseY: n
            ...
            draw: function () {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                if (!this.hide) {
                    var i, n, o = this.context, s = this.stem_direction;
                    s == e.DOWN ? (i = this.x_begin + e.WIDTH / 2, n = this.y_top + 2) : (i = this.x_end + e.WIDTH / 2, n = this.y_bottom - 2), n += this.y_extend * s, t('Rendering stem - ', 'Top Y: ', this.y_top, 'Bottom Y: ', this.y_bottom), o.beginPath(), o.setLineWidth(e.WIDTH), o.moveTo(i, n), o.lineTo(i, n - this.getHeight()), o.stroke(), o.setLineWidth(1);
                }
            }
        }, e;
    }();
    Vex.Flow.StemmableNote = function () {
        function t() {
            e.DEBUG && Vex.L('Vex.Flow.StemmableNote', arguments);
        }
        var e = function (t) {
                arguments.length > 0 && this.init(t);
            }, s = Vex.Flow.Stem;
        return Vex.Inherit(e, Vex.Flow.Note, {
            init: function (t) {
                e.superclass.init.call(this, t), this.stem = null, this.stem_extension_override = null, this.beam = null;
            },
            getStem: function () {
                return this.stem;
            },
            ...
            getStemLength: function () {
                return s.HEIGHT + this.getStemExtension();
            },
            ...
            setStemDirection: function (t) {
                if (t || (t = s.UP), t != s.UP && t != s.DOWN)
                    throw new Vex.RERR('BadArgument', 'Invalid stem direction: ' + t);
                return this.stem_direction = t, this.stem && (this.stem.setDirection(t), this.stem.setExtension(this.getStemExtension())), this.beam = null, this.preFormatted && this.preFormat(), this;
            },
            getStemX: function () {
                var t = this.getAbsoluteX() + this.x_shift, e = this.getAbsoluteX() + this.x_shift + this.glyph.head_width, i = this.stem_direction == s.DOWN ? t : e;
                return i -= s.WIDTH / 2 * this.stem_direction;
            },
            ...
            getStemExtension: function () {
                var t = this.getGlyph();
                return null != this.stem_extension_override ? this.stem_extension_override : t ? 1 === this.getStemDirection() ? t.stem_up_extension : t.stem_down_extension : 0;
            },
            setStemLength: function (t) {
                return this.stem_extension_override = t - s.HEIGHT, this;
            },
            getStemExtents: function () {
                if (!this.ys || 0 === this.ys.length)
                    throw new Vex.RERR('NoYValues', 'Can\'t get top stem Y when note has no Y values.');
                for (var e = this.ys[0], i = this.ys[0], n = s.HEIGHT + this.getStemExtension(), o = 0; o < this.ys.length; ++o) {
                    var h = this.ys[o] + n * -this.stem_direction;
                    this.stem_direction == s.DOWN ? (e = e > h ? e : h, i = i < this.ys[o] ? i : this.ys[o]) : (e = h > e ? e : h, i = i > this.ys[o] ? i : this.ys[o]), ('s' == this.noteType || 'x' == this.noteType) && (e -= 7 * this.stem_direction, i -= 7 * this.stem_direction);
                }
                return t('Stem extents: ', e, i), {
                    topY: e,
                    baseY: i
                };
            },
            ...
            drawStem: function (t) {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                this.setStem(new s(t)), this.stem.setContext(this.context).draw();
            }
        }), e;
    }();
    Vex.Flow.StaveNote = function () {
        function t() {
            e.DEBUG && Vex.L('Vex.Flow.StaveNote', arguments);
        }
        var e = function (t) {
                arguments.length > 0 && this.init(t);
            }, i = Vex.Flow.Stem, s = Vex.Flow.NoteHead;
        return e.STEM_UP = i.UP, e.STEM_DOWN = i.DOWN, Vex.Inherit(e, Vex.Flow.StemmableNote, {
            init: function (t) {
                if (e.superclass.init.call(this, t), this.keys = t.keys, this.clef = t.clef, this.beam = null, this.glyph = Vex.Flow.durationToGlyph(this.duration, this.noteType), !this.glyph)
                    throw new Vex.RuntimeError('BadArguments', 'Invalid note initialization data (No glyph found): ' + JSON.stringify(t));
                this.displaced = !1, this.dot_shiftY = 0, this.keyProps = [], this.use_default_head_x = !1, this.note_heads = [], this.modifiers = [], Vex.Merge(this.render_options, {
                    glyph_font_scale: 35,
                    stroke_px: 3
                }), this.calculateKeyProps(), this.buildStem(), t.auto_stem ? this.autoStem() : this.setStemDirection(t.stem_direction), this.buildNoteHeads(), this.calcExtraPx();
            },
            buildStem: function () {
                var t = this.getGlyph(), e = 0;
                ('v95' == t.code_head || 'v3e' == t.code_head) && (e = -4);
                var s = new i({ y_extend: e });
                this.isRest() && (s.hide = !0), this.setStem(s);
            },
            buildNoteHeads: function () {
                var t = this.getStemDirection(), e = this.getKeys(), n = null, o = null, h = !1, r = 0, a = e.length, d = 1;
                t === i.DOWN && (r = e.length - 1, a = -1, d = -1);
                for (var l = r; l != a; l += d) {
                    var u = this.keyProps[l], f = u.line;
                    null === n ? n = f : (o = Math.abs(n - f), 0 === o || 0.5 === o ? h = !h : (h = !1, this.use_default_head_x = !0)), n = f;
                    var c = new s({
            ...
            autoStem: function () {
                var t;
                this.min_line = this.keyProps[0].line, this.max_line = this.keyProps[this.keyProps.length - 1].line;
                var e = (this.min_line + this.max_line) / 2;
                t = 3 > e ? 1 : -1, this.setStemDirection(t);
            },
            calculateKeyProps: function () {
                for (var t = null, e = 0; e < this.keys.length; ++e) {
                    var i = this.keys[e];
                    this.glyph.rest && (this.glyph.position = i);
                    var s = Vex.Flow.keyProperties(i, this.clef);
                    if (!s)
                        throw new Vex.RuntimeError('BadArguments', 'Invalid key for note properties: ' + i);
                    var n = s.line;
                    null === t ? t = n : 0.5 == Math.abs(t - n) && (this.displaced = !0, s.displaced = !0, this.keyProps.length > 0 && (this.keyProps[e - 1].displaced = !0)), t = n, this.keyProps.push(s);
                }
            ...
            getBoundingBox: function () {
                if (!this.preFormatted)
                    throw new Vex.RERR('UnformattedNote', 'Can\'t call getBoundingBox on an unformatted note.');
                var t = this.getMetrics(), e = t.width, i = this.getAbsoluteX() - t.modLeftPx - t.extraLeftPx, s = 0, n = 0, o = this.getStave().getSpacingBetweenLines() / 2, h = 2 * o;
                if (this.isRest()) {
                    var r = this.ys[0];
                    'w' == this.duration || 'h' == this.duration || '1' == this.duration || '2' == this.duration ? (s = r - o, n = r + o) : (s = r - this.glyph.line_above * h, n = r + this.glyph.line_below * h);
                } else if (this.glyph.stem) {
                    var a = this.getStemExtents();
                    a.baseY += o * this.stem_direction, s = Vex.Min(a.topY, a.baseY), n = Vex.Max(a.topY, a.baseY);
                } else {
                    s = null, n = null;
                    for (var d = 0; d < this.ys.length; ++d) {
                        var l = this.ys[d];
                        0 === d ? (s = l, n = l) : (s = Vex.Min(l, s), n = Vex.Max(l, n)), s -= o, n += o;
                    }
                }
                return new Vex.Flow.BoundingBox(i, s, e, n - s);
            },
            ...
            setStave: function (t) {
                ...
                var i = this.note_heads.map(function (e) {
                        return e.setStave(t), e.getY();
                    });
                this.setYs(i);
                var s = this.getNoteHeadBounds();
                return this.stem.setYBounds(s.y_top, s.y_bottom), this;
            },
            getKeys: function () {
                return this.keys;
            },
            ...
            getLineForRest: function () {
                ...
                if (this.keyProps.length > 1) {
                    var e = this.keyProps[this.keyProps.length - 1].line, i = Vex.Max(t, e), s = Vex.Min(t, e);
                    t = Vex.MidLine(i, s);
                }
                return t;
            },
            ...
            getNoteHeadBounds: function () {
                var t = null, e = null, i = this.stave.getNumLines(), s = 1;
                return this.note_heads.forEach(function (n) {
                    var o = n.getLine(), h = n.getY();
                    (null === t || t > h) && (t = h), (null === e || h > e) && (e = h), i = o > i ? o : i, s = s > o ? o : s;
                }, this), {
                    y_top: t,
                    y_bottom: e,
                    highest_line: i,
            ...
            getNoteHeadEndX: function () {
                ...
                return t + this.glyph.head_width - Vex.Flow.STEM_WIDTH / 2;
            },
            drawLedgerLines: function () {
                function t(t) {
                    r.use_default_head_x === !0 && (h = r.getAbsoluteX() + r.x_shift);
                    var e = h - r.render_options.stroke_px, s = h + r.glyph.head_width - h + 2 * r.render_options.stroke_px;
                    i.fillRect(e, t, s, 1);
                }
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                var e, i = this.context, s = this.getNoteHeadBounds(), n = s.highest_line, o = s.lowest_line, h = this.note_heads[0].getAbsoluteX(), r = this;
                for (e = 6; n >= e; ++e)
                    t(this.stave.getYForNote(e));
                for (e = 0; e >= o; --e)
                    t(this.stave.getYForNote(e));
            },
            drawModifiers: function () {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                for (var t = this.context, e = 0; e < this.modifiers.length; e++) {
                    var i = this.modifiers[e], s = this.note_heads[i.getIndex()], n = s.getStyle();
                    n && (t.save(), s.applyKeyStyle(t)), i.setContext(t), i.draw(), n && t.restore();
                }
            },
            drawFlag: function () {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                var t = this.context, e = this.getGlyph(), s = null === this.beam, n = this.getNoteHeadBounds(), o = this.getNoteHeadBeginX(), h = this.getNoteHeadEndX();
                if (e.flag && s) {
                    var r, a, d, l = this.stem.getHeight();
                    this.getStemDirection() === i.DOWN ? (r = o + 1, a = n.y_top - l + 2, d = e.code_flag_downstem) : (r = h + 1, a = n.y_bottom - l - 2, d = e.code_flag_upstem), Vex.Flow.renderGlyph(t, r, a, this.render_options.glyph_font_scale, d);
                }
            },
            drawNoteHeads: function () {
                this.note_heads.forEach(function (t) {
            ...
            drawStem: function (t) {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                t && this.setStem(new i(t)), this.stem.setContext(this.context).draw();
            },
            draw: function () {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                ...
                var e = this.getNoteHeadBeginX(), i = this.getNoteHeadEndX(), s = this.hasStem() && !this.beam;
                this.note_heads.forEach(function (t) {
                    t.setX(e);
                }, this), this.stem.setNoteHeadXBounds(e, i), t('Rendering ', this.isChord() ? 'chord :' : 'note :', this.keys), this.drawLedgerLines(), s && this.drawStem(), this.drawNoteHeads(), this.drawFlag(), this.drawModifiers();
            }
        }), e;
    }();
    Vex.Flow.TabNote = function () {
        ...
        function e(t, e) {
            for (var i = [], s = [], o = 1; t >= o; o++) {
                var n = e.indexOf(o) > -1;
                n ? (i.push(s), s = []) : s.push(o);
            }
            return s.length > 0 && i.push(s), i;
        }
        function i(t, e, i, s) {
            var o = 1 !== s, n = -1 !== s, h = i.getSpacingBetweenLines(), r = i.getNumLines(), a = [];
            return e.forEach(function (e) {
                var d = e.indexOf(r) > -1, u = e.indexOf(1) > -1;
                if (!(o && u || n && d)) {
                    1 === e.length && e.push(e[0]);
                    var l = [];
                    e.forEach(function (e, o, n) {
                        var a = 1 === e, d = e === r, u = i.getYForLine(e - 1);
                        0 !== o || a ? o !== n.length - 1 || d || (u += h / 2 - 1) : u -= h / 2 - 1, l.push(u), 1 === s && a ? l.push(t - 2) : -1 === s && d && l.push(t + 2);
                    }), a.push(l.sort(function (t, e) {
                        return t - e;
                    }));
                }
            }), a;
        ...
        return Vex.Inherit(t, Vex.Flow.StemmableNote, {
            init: function (t, e) {
                ...
                if (i.init.call(this, t), this.ghost = !1, this.positions = t.positions, Vex.Merge(this.render_options, {
                        glyph_font_scale: 30,
                        draw_stem: e,
                        draw_dots: e,
                        draw_stem_through_stave: !1
                    }), this.glyph = Vex.Flow.durationToGlyph(this.duration, this.noteType), !this.glyph)
                    throw new Vex.RuntimeError('BadArguments', 'Invalid note initialization data (No glyph found): ' + JSON.stringify(t));
                this.buildStem(), this.setStemDirection(s.UP), this.ghost = !1, this.updateWidth();
            },
            getCategory: function () {
                return 'tabnotes';
            },
            ...
            updateWidth: function () {
                ...
                for (var t = 0; t < this.positions.length; ++t) {
                    var e = this.positions[t].fret;
                    this.ghost && (e = '(' + e + ')');
                    var i = Vex.Flow.tabToGlyph(e);
                    this.glyphs.push(i), this.width = i.width > this.width ? i.width : this.width;
                }
            },
            setStave: function (t) {
                var e = Vex.Flow.TabNote.superclass;
                e.setStave.call(this, t), this.context = t.context, this.width = 0;
                var i;
                if (this.context)
                    for (i = 0; i < this.glyphs.length; ++i) {
                        var s = '' + this.glyphs[i].text;
                        'X' != s.toUpperCase() && (this.glyphs[i].width = this.context.measureText(s).width), this.width = this.glyphs[i].width > this.width ? this.glyphs[i].width : this.width;
                    }
                var o = [];
                for (i = 0; i < this.positions.length; ++i) {
                    var n = this.positions[i].str;
                    o.push(this.stave.getYForLine(n - 1));
                }
                return this.setYs(o);
            },
            ...
            getTieRightX: function () {
                var t = this.getAbsoluteX(), e = this.glyph.head_width;
                return t += e / 2, t += -this.width / 2 + this.width + 2;
            },
            getTieLeftX: function () {
                var t = this.getAbsoluteX(), e = this.glyph.head_width;
                return t += e / 2, t -= this.width / 2 + 2;
            },
            getModifierStartXY: function (t, e) {
                if (!this.preFormatted)
                    throw new Vex.RERR('UnformattedNote', 'Can\'t call GetModifierStartXY on an unformatted note');
                if (0 === this.ys.length)
                    throw new Vex.RERR('NoYValues', 'No Y-Values calculated for this note.');
                var i = 0;
                if (t == Vex.Flow.Modifier.Position.LEFT)
                    i = -2;
                else if (t == Vex.Flow.Modifier.Position.RIGHT)
                    i = this.width + 2;
            ...
            getStemY: function () {
                var t = this.stave.getNumLines(), e = -0.5, i = t - 0.5, o = s.UP === this.stem_direction ? e : i;
                return this.stave.getYForLine(o);
            },
            getStemExtents: function () {
                var t = this.getStemY(), e = t + s.HEIGHT * -this.stem_direction;
                return {
                    topY: e,
                    baseY: t
                };
            ...
            drawFlag: function () {
                var t = null == this.beam && this.render_options.draw_stem, e = null == this.beam && t;
                if (this.glyph.flag && e) {
                    var i, o = this.getStemX() + 1, n = this.getStemY() - this.stem.getHeight();
                    i = this.stem_direction == s.DOWN ? this.glyph.code_flag_downstem : this.glyph.code_flag_upstem, Vex.Flow.renderGlyph(this.context, o, n, this.render_options.glyph_font_scale, i);
                }
            },
            drawModifiers: function () {
            ...
            drawStemThrough: function () {
                var t = this.getStemX(), o = this.getStemY(), n = this.context, h = this.render_options.draw_stem_through_stave, r = this.render_options.draw_stem;
                if (r && h) {
                    var a = this.stave.getNumLines(), d = this.positions.map(function (t) {
                            return t.str;
                        }), u = e(a, d), l = i(o, u, this.getStave(), this.getStemDirection());
                    this.beam && 1 !== this.getStemDirection() || (t += s.WIDTH / 2), n.save(), n.setLineWidth(s.WIDTH), l.forEach(function (e) {
                        n.beginPath(), n.moveTo(t, e[0]), n.lineTo(t, e[e.length - 1]), n.stroke(), n.closePath();
                    }), n.restore();
                }
            },
            drawPositions: function () {
                for (var t, e = this.context, i = this.getAbsoluteX(), s = this.ys, o = 0; o < this.positions.length; ++o) {
                    t = s[o];
                    var n = this.glyphs[o], h = this.glyph.head_width, r = i + h / 2 - n.width / 2;
                    if (e.clearRect(r - 2, t - 3, n.width + 4, 6), n.code)
                        Vex.Flow.renderGlyph(e, r, t + 5 + n.shift_y, this.render_options.glyph_font_scale, n.code);
                    else {
                        var a = n.text.toString();
                        e.fillText(a, r, t + 5);
                    }
                }
            },
            draw: function () {
                ...
                var e = this.getStemX(), i = this.getStemY();
                t && this.drawStem({
                    x_begin: e,
                    x_end: e,
                    y_top: i,
                ...
                }), this.drawFlag(), this.drawModifiers();
            }
        }), t;
    }();
    ...
    Vex.Flow.ClefNote = function () {
        ...
        return Vex.Inherit(t, Vex.Flow.Note, {
            init: function (e) {
                t.superclass.init.call(this, { duration: 'b' }), this.setClef(e), this.ignore_ticks = !0;
            },
            setClef: function (t) {
    ...
    Vex.Flow.TimeSigNote = function () {
        ...
        return Vex.Inherit(t, Vex.Flow.Note, {
            init: function (i, e) {
                t.superclass.init.call(this, { duration: 'b' });
    ...
    Vex.Flow.Beam = function () {
        ...
        return t.prototype = {
            init: function (t, e) {
                ...
                if (this.ticks = t[0].getIntrinsicTicks(), this.ticks >= Vex.Flow.durationToTicks('4'))
                    throw new Vex.RuntimeError('BadArguments', 'Beams can only be applied to notes shorter than a quarter note.');
                var n, i;
                for (this.stem_direction = 1, n = 0; n < t.length; ++n)
                    if (i = t[n], i.hasStem()) {
                        this.stem_direction = i.getStemDirection();
                        break;
                    }
                var s = -1;
                if (e && 'stavenotes' === t[0].getCategory()) {
                    for (this.min_line = 1000, n = 0; n < t.length; ++n)
                        if (i = t[n], i.getKeyProps) {
                            var o = i.getKeyProps(), r = (o[0].line + o[o.length - 1].line) / 2;
                            this.min_line = Math.min(r, this.min_line);
                        }
                    this.min_line < 3 && (s = 1);
                ...
                for (n = 0; n < t.length; ++n)
                    i = t[n], e && (i.setStemDirection(s), this.stem_direction = s), i.setBeam(this);
            ...
            breakSecondaryAt: function (t) {
                return this.break_on_indices = t, this;
            },
            getSlopeY: function (t, e, n, i) {
                return n + (t - e) * i;
            },
            calculateSlope: function () {
                for (var t = this.notes[0], e = t.getStemExtents().topY, n = t.getStemX(), i = (this.render_options.max_slope - this.render_options.min_slope) / this.render_options.slope_iterations, s = Number.MAX_VALUE, o = 0, r = 0, a = this.render_options.min_slope; a <= this.render_options.max_slope; a += i) {
                    for (var h = 0, c = 0, u = 1; u < this.notes.length; ++u) {
                        var l = this.notes[u], m = l.getStemX(), f = l.getStemExtents().topY, p = this.getSlopeY(m, n, e, a) + c;
                        if (f * this.stem_direction < p * this.stem_direction) {
                            var _ = Math.abs(f - p);
                            c += _ * -this.stem_direction, h += _ * u;
                        } else
                            h += (f - p) * this.stem_direction;
                    }
                    var d = Math.abs(h);
                    s > d && (s = d, o = a, r = c);
                }
                this.slope = o, this.y_shift = r;
            },
            applyStemExtensions: function () {
                for (var t = this.notes[0], n = t.getStemExtents().topY, i = t.getStemX(), s = 0; s < this.notes.length; ++s) {
                    var o = this.notes[s], r = o.getStemX(), a = o.getStemExtents(), h = a.baseY, c = a.topY;
                    h += this.stem_direction * o.glyph.stem_offset;
                    var u = Vex.Flow.STEM_WIDTH;
                    if (o.hasStem()) {
                        var l = this.getSlopeY(r, i, n, this.slope) + this.y_shift;
                        o.setStem(new Vex.Flow.Stem({
                            x_begin: r - Vex.Flow.STEM_WIDTH / 2,
                            x_end: r,
                            y_top: 1 === this.stem_direction ? c : h,
                            y_bottom: 1 === this.stem_direction ? h : c,
                            y_extend: u,
                            stem_extension: Math.abs(c - l) - e.HEIGHT - 1,
                            stem_direction: this.stem_direction
                        }));
                    } else if (o.isRest() && this.render_options.show_stemlets) {
                        var m = o.getCenterGlyphX(), f = this.render_options.beam_width, p = 1.5 * (this.beam_count - 1) * f + f, _ = p - u + this.render_options.stemlet_extension, d = this.getSlopeY(m, i, n, this.slope) + this.y_shift, g = d + Vex.Flow.Stem.HEIGHT * this.stem_direction, x = d + _ * this.stem_direction;
                        o.setStem(new Vex.Flow.Stem({
                            x_begin: m,
                            x_end: m,
                            y_bottom: 1 === this.stem_direction ? x : g,
                            y_top: 1 === this.stem_direction ? g : x,
                            y_extend: u,
                            stem_extension: -1,
                            stem_direction: this.stem_direction
                        }));
            ...
            getBeamLines: function (t) {
                function e(e, n) {
                    var i = 0;
                    n && e && (i = e.getBeamCount() - n.getBeamCount());
                    var s = '8' !== t && i > 0, o = '8' !== t && 0 > i;
                    return {
                        left: s,
                        right: o
                    };
                }
                for (var n, i = [], s = !1, o = this.render_options.partial_beam_length, r = 0; r < this.notes.length; ++r) {
                    var a = this.notes[r], h = this.notes[r - 1], c = this.notes[r + 1], u = a.getIntrinsicTicks(), l = e(h, c), m = a.isRest() ? a.getCenterGlyphX() : a.getStemX();
                    if (u < Vex.Flow.durationToTicks(t))
                        if (s) {
                            n = i[i.length - 1], n.end = m;
                            var f = -1 !== this.break_on_indices.indexOf(r), p = parseInt(t, 10) >= 8;
                            f && p && (s = !1);
                        } else {
                            var _ = {
                                    start: m,
                            ...
                            l.left && (_.end = m - o), i.push(_), s = !0;
                        }
                    else
                        s && (n = i[i.length - 1], null == n.end && (n.end = n.start + o)), s = !1;
                }
                return s === !0 && (n = i[i.length - 1], null == n.end && (n.end = n.start - o)), i;
            },
            drawStems: function () {
            ...
            drawBeamLines: function () {
                ...
                for (var t = [
                            ...
                            '32',
                            '64'
                        ], e = this.notes[0], n = this.notes[this.notes.length - 1], i = e.getStemExtents().topY, s = n.getStemExtents().topY, o = e.getStemX(), r = this.render_options.beam_width * this.stem_direction, a = 0; a < t.length; ++a) {
                    for (var h = t[a], c = this.getBeamLines(h), u = 0; u < c.length; ++u) {
                        var l = c[u], m = l.start - (-1 == this.stem_direction ? Vex.Flow.STEM_WIDTH / 2 : 0), f = this.getSlopeY(m, o, i, this.slope), p = l.end + (1 == this.stem_direction ? Vex.Flow.STEM_WIDTH / 3 : -Vex.Flow.STEM_WIDTH / 3), _ = this.getSlopeY(p, o, i, this.slope);
                        this.context.beginPath(), this.context.moveTo(m, f + this.y_shift), this.context.lineTo(m, f + r + this.y_shift), this.context.lineTo(p + 1, _ + r + this.y_shift), this.context.lineTo(p + 1, _ + this.y_shift), this.context.closePath(), this.context.fill();
                    }
                    i += 1.5 * r, s += 1.5 * r;
                }
            },
            ...
            postFormat: function () {
                this.postFormatted || (this.calculateSlope(), this.applyStemExtensions(), this.postFormatted = !0);
            },
            draw: function () {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                if (!this.unbeamable)
                    return this.postFormatted || this.postFormat(), this.drawStems(), this.drawBeamLines(), !0;
            }
        }, t.getDefaultBeamGroups = function (t) {
            t && 'c' != t || (t = '4/4');
            var e = {
                    '1/2': ['1/2'],
                    '2/2': ['1/2'],
                    ...
                    '3/16': ['3/16'],
                    '4/16': ['2/16']
                }, n = Vex.Flow.Fraction, i = e[t];
            if (i)
                return i.map(function (t) {
                    return new n().parse(t);
                });
            var s = parseInt(t.split('/')[0], 10), o = parseInt(t.split('/')[1], 10), r = 0 === s % 3;
            return r ? [new n(3, o)] : o > 4 ? [new n(2, o)] : 4 >= o ? [new n(1, o)] : void 0;
        }, t.applyAndGetBeams = function (e, n, i) {
            return t.generateBeams(e.getTickables(), {
                groups: i,
                stem_direction: n
            });
        }, t.generateBeams = function (t, e) {
            function n(t) {
            ...
            function i() {
                l.length - 1 > f ? f += 1 : f = 0;
            }
            function s() {
                var t = [];
                m.forEach(function (e) {
                    if (t = [], e.shouldIgnoreTicks())
                        return p.push(_), _ = t, void 0;
                    _.push(e);
                    var s = l[f].value(), o = n(_).value();
                    parseInt(e.duration, 10) < 8 && e.tuplet && (s *= 2), o > s ? (t.push(_.pop()), p.push(_), _ = t, i()) : o == s && (p.push(_), _ = t, i());
                }), _.length > 0 && p.push(_);
            }
            function o() {
            ...
            function r() {
                ...
                p.forEach(function (n) {
                    var i = [];
                    n.forEach(function (n, s, o) {
                        var r = 0 === s || s === o.length - 1, a = !e.beam_rests && n.isRest(), h = e.beam_rests && e.beam_middle_only && n.isRest() && r, c = a || h;
                        c ? (i.length > 0 && t.push(i), i = []) : i.push(n);
                    }), i.length > 0 && t.push(i);
                }), p = t;
            }
            function a() {
            ...
            e || (e = {}), e.groups && e.groups.length || (e.groups = [new Vex.Flow.Fraction(2, 8)]);
            var l = e.groups.map(function (t) {
                    if (!t.multiply)
                        throw new Vex.RuntimeError('InvalidBeamGroups', 'The beam groups must be an array of Vex.Flow.Fractions');
                    return t.clone().multiply(Vex.Flow.RESOLUTION, 1);
                }), m = t, f = 0, p = [], _ = [];
            s(), r(), a();
            var d = o(), g = u(), x = [];
            return d.forEach(function (t) {
                var n = new Vex.Flow.Beam(t);
                e.show_stemlets && (n.render_options.show_stemlets = !0), x.push(n);
            }), g.forEach(function (t) {
                for (var e = t[0], n = 0; n < t.length; ++n)
                    if (t[n].hasStem()) {
                        e = t[n];
                        break;
                    }
                var i = e.tuplet;
                e.beam && i.setBracketed(!1), -1 == e.stem_direction && i.setTupletLocation(Vex.Flow.Tuplet.LOCATION_BOTTOM);
            }), x;
        }, t;
    }();
    Vex.Flow.Voice = function () {
        ...
        return t.Mode = {
                ...
                if (!this.boundingBox) {
                    ...
                    for (var e = 0; e < this.tickables.length; ++e)
                        if (this.tickables[e].setStave(t), e > 0 && i) {
                            var o = this.tickables[e].getBoundingBox();
                            o && i.mergeWith(o);
                        }
                    this.boundingBox = i;
                }
            ...
            addTickable: function (t) {
                if (!t.shouldIgnoreTicks()) {
                    var i = t.getTicks();
                    if (this.ticksUsed.add(i), (this.mode == Vex.Flow.Voice.Mode.STRICT || this.mode == Vex.Flow.Voice.Mode.FULL) && this.ticksUsed.value() > this.totalTicks.value())
                        throw this.totalTicks.subtract(i), new Vex.RERR('BadArgument', 'Too many ticks.');
            ...
            addTickables: function (t) {
                for (var i = 0; i < t.length; ++i)
                    this.addTickable(t[i]);
                return this;
            },
            preFormat: function () {
                return this.preFormatted ? void 0 : (this.tickables.forEach(function (t) {
                    t.getStave() || t.setStave(this.stave);
                }, this), this.preFormatted = !0, this);
            },
            draw: function (t, i) {
                for (var e = null, o = 0; o < this.tickables.length; ++o) {
                    var s = this.tickables[o];
                    if (i && s.setStave(i), !s.getStave())
                        throw new Vex.RuntimeError('MissingStave', 'The voice cannot draw tickables without staves.');
                    if (0 === o && (e = s.getBoundingBox()), o > 0 && e) {
                        var n = s.getBoundingBox();
                        n && e.mergeWith(n);
                    }
                    s.setContext(t), s.draw();
                }
                this.boundingBox = e;
            }
        }, t;
    ...
    Vex.Flow.Modifier = function () {
        ...
        function i() {
            t.DEBUG && Vex.L('Vex.Flow.Modifier', arguments);
        }
        return t.Position = {
            LEFT: 1,
            RIGHT: 2,
            ...
            init: function () {
                this.width = 0, this.context = null, this.note = null, this.index = null, this.text_line = 0, this.position = t.Position.LEFT, this.modifier_context = null, this.x_shift = 0, this.y_shift = 0, i('Created new modifier');
            },
            getCategory: function () {
                return 'none';
            },
    ...
    Vex.Flow.ModifierContext = function () {
        function t() {
            this.modifiers = {}, this.preFormatted = !1, this.postFormatted = !1, this.width = 0, this.spacing = 0, this.state = {
                left_shift: 0,
                right_shift: 0,
                text_line: 0
            };
        ...
        var e = function (t, e, i) {
                if (Vex.Debug) {
                    var s, n = 0;
                    1 == i ? (s = e.isrest ? 0 : 0.5, n = e.max_line - t.min_line, n += s) : (s = e.isrest ? 0 : 0.5, n = e.min_line - t.max_line, n -= s), t.line += n, t.max_line += n, t.min_line += n, t.note.keyProps[0].line += n;
                }
            }, i = function (t, e, i) {
        ...
        return t.prototype = {
            ...
            formatNotes: function () {
                ...
                if (!t || t.length < 2)
                    return this;
                if (null != t[0].getStave())
                    return this.formatNotesByY(t);
                for (var s = [], n = 0; n < t.length; n++) {
                    var r, h = t[n].getKeyProps(), o = h[0].line, a = h[h.length - 1].line, f = t[n].getStemDirection(), l = t[n].getStemLength() / 10, g = t[n].getStemMinumumLength() / 10;
                    t[n].isRest() ? (r = o + t[n].glyph.line_above, a = o - t[n].glyph.line_below) : (r = 1 == f ? h[h.length - 1].line + l : h[h.length - 1].line, a = 1 == f ? h[0].line : h[0].line - l), s.push({
                        line: h[0].line,
                        max_line: r,
                        min_line: a,
                        isrest: t[n].isRest(),
                ...
                var m = s.length, u = s[0], _ = m > 2 ? s[1] : null, d = m > 2 ? s[2] : s[1];
                2 == m && -1 == u.stem_dir && 1 == d.stem_dir && (u = s[1], d = s[0]);
                var c, v = Math.max(u.voice_shift, d.voice_shift), x = 0;
                if (2 == m) {
                    var p = u.stem_dir == d.stem_dir ? 0 : 0.5;
                    return u.stem_dir == d.stem_dir && u.min_line <= d.max_line && (u.isrest || (c = Math.abs(u.line - (d.max_line + 0.5)), c = Math.max(c, u.stem_min), u.min_line = u.line - c, u.note.setStemLength(10 * c))), u.min_line <= d.max_line + p && (u.isrest ? e(u, d, 1) : d.isrest ? e(d, u, -1) : (x = v, u.stem_dir == d.stem_dir ? u.note.setXShift(x + 3) : d.note.setXShift(x))), this;
                }
                if (null != _ && _.min_line < d.max_line + 0.5 && (_.isrest || (c = Math.abs(_.line - (d.max_line + 0.5)), c = Math.max(c, _.stem_min), _.min_line = _.line - c, _.note.setStemLength(10 * c))), _.isrest && !u.isrest && !d.isrest && (u.min_line <= _.max_line || _.min_line <= d.max_line)) {
                    var S = _.max_line - _.min_line, y = u.min_line - d.max_line;
                    return y > S ? i(_, u, d) : (x = v + 3, _.note.setXShift(x)), this;
                }
                return u.isrest && _.isrest && d.isrest ? (e(u, _, 1), e(d, _, -1), this) : (_.isrest && u.isrest && _.min_line <= d.max_line && e(_, d, 1), _.isrest && d.isrest && u.min_line <= _.max_line && e(_, u, -1), u.isrest && u.min_line <= _.max_line && e(u, _, 1), d.isrest && _.min_line <= d.max_line && e(d, _, -1), (!u.isrest && !_.isrest && u.min_line <= _.max_line + 0.5 || !_.isrest && !d.isrest && _.min_line <= d.max_line) && (x = v + 3, _.note.setXShift(x)), this);
            },
            formatNotesByY: function (t) {
                var e, i = !0;
                for (e = 0; e < t.length; e++)
                    i = i && null != t[e].getStave();
                if (!i)
                ...
                for (e = 0; e < t.length - 1; e++) {
                    ...
                    var h = n.getKeyProps(), o = r.getKeyProps(), a = n.getStave().getYForLine(h[0].line), f = r.getStave().getYForLine(o[o.length - 1].line), l = n.getStave().options.spacing_between_lines_px;
                    Math.abs(a - f) == l / 2 && (s = n.getVoiceShiftWidth(), r.setXShift(s));
                }
                return this.state.right_shift += s, this;
            },
            formatDots: function () {
                var t = this.state.right_shift, e = this.modifiers.dots, i = 1;
                if (!e || 0 === e.length)
                    return this;
                var s, n, r, h, o = [];
                for (s = 0; s < e.length; ++s) {
                    n = e[s], r = n.getNote();
                    var a;
                    'function' == typeof r.getKeyProps ? (a = r.getKeyProps()[n.getIndex()], h = a.displaced ? r.getExtraRightPx() : 0) : (a = { line: 0.5 }, h = 0), o.push({
                        line: a.line,
                        shift: h,
                        note: r,
                        dot: n
                ...
                var f = t, l = 0, g = null, m = null, u = null, _ = 0;
                for (s = 0; s < o.length; ++s) {
                    n = o[s].dot, r = o[s].note, h = o[s].shift;
                    var d = o[s].line;
                    (d != g || r != m) && (f = h), r.isRest() || d == g || (0.5 == Math.abs(d % 1) ? _ = 0 : r.isRest() || (_ = 0.5, null == m || m.isRest() || 0.5 != g - d ? d + _ == u && (_ = -0.5) : _ = -0.5)), n.dot_shiftY += -_, u = d + _, n.setXShift(f), f += n.getWidth() + i, l = f > l ? f : l, g = d, m = r;
                }
                return this.state.right_shift += l, this;
            },
            formatAccidentals: function () {
                var t = this.state.left_shift, e = this.modifiers.accidentals, i = 2;
                if (!e || 0 === e.length)
                    return this;
                var s, n, r, h = [], o = !1, a = null, f = 0;
                for (s = 0; s < e.length; ++s) {
                    n = e[s];
                    var l = n.getNote(), g = l.getStave(), m = l.getKeyProps()[n.getIndex()];
                    if (l != a) {
                        for (var u = 0; u < l.keys.length; ++u)
                            r = l.getKeyProps()[u], f = r.displaced ? l.getExtraLeftPx() : f;
                        a = l;
                    }
                    if (null != g) {
                        o = !0;
                        var _ = g.options.spacing_between_lines_px, d = g.getYForLine(m.line);
                        h.push({
                            y: d,
                            shift: f,
                            acc: n,
                ...
                if (o)
                    return this.formatAccidentalsByY(h);
                h.sort(function (t, e) {
                    return e.line - t.line;
                });
                var c = h[0].shift, v = 0, x = h[0].line;
                for (s = 0; s < h.length; ++s) {
                    n = h[s].acc;
                    var p = h[s].line, S = h[s].shift;
                    x - 3 > p && (x = p, c = S), n.setXShift(t + c), c += n.getWidth() + i, v = c > v ? c : v;
                }
                return this.state.left_shift += v, this;
            },
            formatAccidentalsByY: function (t) {
                var e = this.state.left_shift, i = 2;
                t.sort(function (t, e) {
                    return e.y - t.y;
                });
                for (var s = t[0].shift, n = 0, r = t[0].y, h = 0; h < t.length; ++h) {
                    var o = t[h].acc, a = t[h].y, f = t[h].shift;
                    r - a > 3 * t[h].lineSpace && (r = a, s = f), o.setXShift(s + e), s += o.getWidth() + i, n = s > n ? s : n;
                }
                return this.state.left_shift += n, this;
            },
            formatStrokes: function () {
                var t = this.state.left_shift, e = this.modifiers.strokes, i = 0;
                if (!e || 0 === e.length)
                    return this;
                var s, n, r, h = [];
                for (s = 0; s < e.length; ++s) {
                    n = e[s];
                    var o, a = n.getNote();
                    a instanceof Vex.Flow.StaveNote ? (o = a.getKeyProps()[n.getIndex()], r = o.displaced ? a.getExtraLeftPx() : 0, h.push({
                        line: o.line,
                        shift: r,
                        str: n
                    })) : (o = a.getPositions()[n.getIndex()], h.push({
                        line: o.str,
                        shift: 0,
                        str: n
                    }));
                ...
                var f = t, l = 0;
                for (s = 0; s < h.length; ++s)
                    n = h[s].str, r = h[s].shift, n.setXShift(f + r), l = Math.max(n.getWidth() + i, l);
                return this.state.left_shift += l, this;
            },
            formatStringNumbers: function () {
                var t = this.state.left_shift, e = this.state.right_shift, i = this.modifiers.stringnumber, s = 1;
                if (!i || 0 === i.length)
                    return this;
                var n, r, h, o, a, f = [], l = null, g = 0, m = 0;
                for (n = 0; n < i.length; ++n)
                    for (r = i[n], h = r.getNote(), n = 0; n < i.length; ++n) {
                        r = i[n], h = r.getNote(), o = r.getPosition();
                        var u = h.getKeyProps()[r.getIndex()];
                        if (h != l) {
                            for (var _ = 0; _ < h.keys.length; ++_)
                                a = h.getKeyProps()[_], 0 === t && (g = a.displaced ? h.getExtraLeftPx() : g), 0 === e && (m = a.displaced ? h.getExtraRightPx() : m);
                            l = h;
                        }
                        f.push({
                            line: u.line,
                ...
                var d = 0, c = 0, v = 0, x = 0, p = null, S = null;
                for (n = 0; n < f.length; ++n) {
                    var y = 0;
                    h = f[n].note, o = f[n].pos, r = f[n].num;
                    var P = f[n].line, F = f[n].shiftL, L = f[n].shiftR;
                    (P != p || h != S) && (d = t + F, c = e + L);
                    var M = r.getWidth() + s;
                    o == Vex.Flow.Modifier.Position.LEFT ? (r.setXShift(t), y = g + M, v = y > v ? y : v) : o == Vex.Flow.Modifier.Position.RIGHT && (r.setXShift(c), y += M, x = y > x ? y : x), p = P, S = h;
                }
                return this.state.left_shift += v, this.state.right_shift += x, this;
            },
            formatFretHandFingers: function () {
                var t = this.state.left_shift, e = this.state.right_shift, i = this.modifiers.frethandfinger, s = 1;
                if (!i || 0 === i.length)
                    return this;
                var n, r, h, o, a, f = [], l = null, g = 0, m = 0;
                for (n = 0; n < i.length; ++n) {
                ...
                for (n = 0; n < f.length; ++n) {
                    ...
                    (P != p || h != S) && (d = t + F, c = e + L);
                    var M = r.getWidth() + s;
                    o == Vex.Flow.Modifier.Position.LEFT ? (r.setXShift(t + d), y = t + M, v = y > v ? y : v) : o == Vex.Flow.Modifier.Position.RIGHT && (r.setXShift(c), y = m + M, x = y > x ? y : x), p = P, S = h;
                }
                return this.state.left_shift += v, this.state.right_shift += x, this;
            },
            ...
            formatVibratos: function () {
                ...
                if (!t || 0 === t.length)
                    return this;
                var e = this.state.text_line, i = 0, s = this.state.right_shift - 7, n = this.modifiers.bends;
                n && n.length > 0 && e--;
            ...
            formatGraceNoteGroups: function () {
                var t = this.modifiers.gracenotegroups, e = 4;
                if (!t || 0 === t.length)
                    return this;
                var i, s, n, r = [], h = !1, o = null, a = 0;
                for (i = 0; i < t.length; ++i) {
                    s = t[i];
                    var f = s.getNote(), l = f.getStave();
                    if (f != o) {
                        for (var g = 0; g < f.keys.length; ++g)
                            n = f.getKeyProps()[g], a = n.displaced ? f.getExtraLeftPx() : a;
                        o = f;
                    }
                    null != l ? (h = !0, r.push({
                        shift: a,
                ...
                for (i = 0; i < r.length; ++i)
                    s = r[i].gracenote_group, s.preFormat(), m = s.getWidth() + e;
                return this.state.left_shift += m, this;
            },
            ...
            preFormat: function () {
                this.preFormatted || (this.formatNotes().formatDots().formatFretHandFingers().formatAccidentals().formatGraceNoteGroups().formatStrokes().formatStringNumbers().formatArticulations().formatAnnotations().formatBends().formatVibratos(), this.width = this.state.left_shift + this.state.right_shift, this.preFormatted = !0);
            },
            postFormat: function () {
                return this.postFormatted ? void 0 : (this.postFormatNotes(), this);
            }
        }, t;
    }();
    Vex.Flow.Accidental = function () {
        ...
        function e() {
            t.DEBUG && Vex.L('Vex.Flow.Accidental', arguments);
        }
        var i = Vex.Flow.Modifier;
        return Vex.Inherit(t, i, {
            init: function (n) {
                if (t.superclass.init.call(this), e('New accidental: ', n), this.note = null, this.index = null, this.type = n, this.position = i.Position.LEFT, this.render_options = {
                        font_scale: 38,
                        stroke_px: 3
                    }, this.accidental = Vex.Flow.accidentalCodes(this.type), !this.accidental)
                    throw new Vex.RERR('ArgumentError', 'Unknown accidental type: ' + n);
                this.cautionary = !1, this.paren_left = null, this.paren_right = null, this.setWidth(this.accidental.width);
            },
            getCategory: function () {
                return 'accidentals';
            },
            setNote: function (t) {
                if (!t)
                    throw new Vex.RERR('ArgumentError', 'Bad note value: ' + t);
                this.note = t, 'gracenotes' === this.note.getCategory() && (this.render_options.font_scale = 25, this.setWidth(this.accidental.gracenote_width));
            },
            ...
            draw: function () {
                ...
                if (!this.note || null == this.index)
                    throw new Vex.RERR('NoAttachedNote', 'Can\'t draw accidental without a note and index.');
                var t = this.note.getModifierStartXY(this.position, this.index), i = t.x + this.x_shift - this.width, n = t.y + this.y_shift;
                e('Rendering: ', this.type, i, n), this.cautionary ? (i += 3, Vex.Flow.renderGlyph(this.context, i, n, this.render_options.font_scale, this.paren_left.code), i += 2, Vex.Flow.renderGlyph(this.context, i, n, this.render_options.font_scale, this.accidental.code), i += this.accidental.width - 2, ('##' == this.type || 'bb' == this.type) && (i -= 2), Vex.Flow.renderGlyph(this.context, i, n, this.render_options.font_scale, this.paren_right.code)) : Vex.Flow.renderGlyph(this.context, i, n, this.render_options.font_scale, this.accidental.code);
            }
        }), t;
    }();
    Vex.Flow.Dot = function () {
        ...
        return Vex.Inherit(t, i, {
            ...
            setNote: function (t) {
                this.note = t, 'gracenotes' === this.note.getCategory() && (this.radius *= 0.5, this.setWidth(3));
            },
            getCategory: function () {
                return 'dots';
            },
            ...
            draw: function () {
                ...
                var t = this.note.stave.options.spacing_between_lines_px, i = this.note.getModifierStartXY(this.position, this.index);
                'tabnotes' === this.note.getCategory() && (i.y = this.note.getStemExtents().baseY);
                var e = i.x + this.x_shift + this.width - this.radius, s = i.y + this.y_shift + this.dot_shiftY * t, n = this.context;
                n.beginPath(), n.arc(e, s, this.radius, 0, 2 * Math.PI, !1), n.fill();
            }
        }), t;
    }();
    Vex.Flow.Formatter = function () {
        function t() {
            this.minTotalWidth = 0, this.hasMinTotalWidth = !1, this.pixelsPerTick = 0, this.totalTicks = new Vex.Flow.Fraction(0, 1), this.tContexts = null, this.mContexts = null;
        }
        function e() {
            t.DEBUG && Vex.L('Vex.Flow.Formatter', arguments);
        }
        function i(t, e, i, o) {
            var n = e;
            for (i++; i < t.length;) {
            ...
            if (o && e != n) {
                var a = Vex.Max(e, n), r = Vex.Min(e, n);
                n = Vex.MidLine(a, r);
            }
            return n;
        }
        function o(t, e, i) {
            ...
            var o, n, a = t[0].getTotalTicks(), r = {}, s = [], l = 1;
            for (o = 0; o < t.length; ++o) {
                if (n = t[o], n.getTotalTicks().value() != a.value())
                    throw new Vex.RERR('TickMismatch', 'Voices should have same time signature.');
                if (n.getMode() == Vex.Flow.Voice.Mode.STRICT && !n.isComplete())
            ...
            for (o = 0; o < t.length; ++o) {
                n = t[o];
                for (var c = n.getTickables(), u = new Vex.Flow.Fraction(0, l), f = 0; f < c.length; ++f) {
                    var x = c[f], d = u.numerator;
                    r[d] || (r[d] = new e()), i(x, r[d]), s.push(d), u.add(x.getTicks());
                }
            }
            return {
                map: r,
        ...
        return t.FormatAndDraw = function (e, i, o, n) {
            ...
            'object' == typeof n ? Vex.Merge(a, n) : 'boolean' == typeof n && (a.auto_beam = n);
            var r = new Vex.Flow.Voice(Vex.Flow.TIME4_4).setMode(Vex.Flow.Voice.Mode.SOFT);
            r.addTickables(o);
            var s = null;
            if (a.auto_beam && (s = Vex.Flow.Beam.applyAndGetBeams(r)), new t().joinVoices([r], { align_rests: a.align_rests }).formatToStave([r], i, { align_rests: a.align_rests }), r.setStave(i), r.draw(e, i), null != s)
                for (var l = 0; l < s.length; ++l)
                    s[l].setContext(e).draw();
            ...
            'object' == typeof s ? Vex.Merge(l, s) : 'boolean' == typeof s && (l.auto_beam = s);
            var h = new Vex.Flow.Voice(Vex.Flow.TIME4_4).setMode(Vex.Flow.Voice.Mode.SOFT);
            h.addTickables(a);
            var c = new Vex.Flow.Voice(Vex.Flow.TIME4_4).setMode(Vex.Flow.Voice.Mode.SOFT);
            c.addTickables(n);
            var u = null;
            if (l.auto_beam && (u = Vex.Flow.Beam.applyAndGetBeams(h)), new t().joinVoices([h], { align_rests: l.align_rests }).joinVoices([c]).formatToStave([
                    h,
                    c
                ], o, { align_rests: l.align_rests }), h.draw(e, o), c.draw(e, i), null != u)
                for (var f = 0; f < u.length; ++f)
                    u[f].setContext(e).draw();
            new Vex.Flow.StaveConnector(o, i).setContext(e).draw();
        }, t.AlignRestsToNotes = function (t, e, o) {
            for (var n = 0; n < t.length; ++n)
                if (t[n] instanceof Vex.Flow.StaveNote && t[n].isRest()) {
                    var a = t[n];
                    if (a.tuplet && !o)
                        continue;
                    var r = a.getGlyph().position.toUpperCase();
                    if ('R/4' != r && 'B/4' != r)
                        continue;
                    if (e || null != a.beam) {
                        var s = a.getKeyProps()[0];
                        if (0 === n)
                            s.line = i(t, s.line, n, !1);
                        else if (n > 0 && n < t.length) {
                            var l;
                            t[n - 1].isRest() ? (l = t[n - 1].getKeyProps()[0].line, s.line = l) : (l = t[n - 1].getLineForRest(), s.line = i(t, l, n, !0));
                        }
                    }
                }
            return this;
            ...
            alignRests: function (e, i) {
                ...
                for (var o = 0; o < e.length; o++)
                    new t.AlignRestsToNotes(e[o].tickables, i);
            },
            preCalculateMinTotalWidth: function (t) {
                if (!this.hasMinTotalWidth) {
                    ...
                    var e = this.tContexts, i = e.list, o = e.map;
            ...
            createModifierContexts: function (t) {
                var e = o(t, Vex.Flow.ModifierContext, function (t, e) {
                        t.addToModifierContext(e);
                    });
                return this.mContexts = e, e;
            },
            createTickContexts: function (t) {
                var e = o(t, Vex.Flow.TickContext, function (t, e) {
                        e.addTickable(t);
                    });
                return this.totalTicks = t[0].getTicksUsed().clone(), this.tContexts = e, e;
            },
            preFormat: function (t, e, i, o) {
                var n = this.tContexts, a = n.list, r = n.map;
                i && o && i.forEach(function (t) {
                    t.setStave(o), t.preFormat();
                }), t ? this.pixelsPerTick = t / (this.totalTicks.value() * n.resolutionMultiplier) : (t = 0, this.pixelsPerTick = 0);
                var s = 0, l = 0, h = 0, c = 0, u = 0, f = null, x = t;
                this.minTotalWidth = 0;
                var d, g, T;
                for (d = 0; d < a.length; ++d) {
                    g = a[d], T = r[g], e && T.setContext(e), T.preFormat();
                    var m = T.getMetrics(), v = T.getWidth();
                    this.minTotalWidth += v;
                    var w = 0, V = v;
                    h = Math.min((g - c) * this.pixelsPerTick, V);
                    var p = s + h;
                    null != f && (w = s + u - f.extraLeftPx), p = T.shouldIgnoreTicks() ? w + T.getWidth() : Math.max(p, w), T.shouldIgnoreTicks() && t && (t -= T.getWidth(), this.pixelsPerTick = t / (this.totalTicks.value() * n.resolutionMultiplier));
                    var F = m.extraLeftPx;
                    null != f && (l = p - s - (u - f.extraLeftPx)), d > 0 && l > 0 && (l >= F ? F = 0 : F -= l), p += F, T.setX(p), T.setPixelsUsed(V), f = m, u = v, c = g, s = p;
                }
                if (this.hasMinTotalWidth = !0, t > 0) {
                    var M = x - (s + u), C = M / (this.totalTicks.value() * n.resolutionMultiplier), R = 0;
                    for (c = 0, d = 0; d < a.length; ++d)
                        g = a[d], T = r[g], h = (g - c) * C, R += h, T.setX(T.getX() + R), c = g;
                }
            },
            postFormat: function () {
                return this.mContexts.list.forEach(function (t) {
                    this.mContexts.map[t].postFormat();
                }, this), this.tContexts.list.forEach(function (t) {
                    this.tContexts.map[t].postFormat();
                }, this), this;
            },
            ...
            format: function (t, e, i) {
                ...
                return Vex.Merge(o, i), this.alignRests(t, o.align_rests), this.createTickContexts(t), this.preFormat(e, o.context, t, o.stave), o.stave && this.postFormat(), this;
            },
            formatToStave: function (t, i, o) {
                var n = i.getNoteEndX() - i.getNoteStartX() - 10;
                e('Formatting voices to width: ', n);
                var a = { context: i.getContext() };
                return Vex.Merge(a, o), this.format(t, n, a);
            }
        }, t;
    }();
    Vex.Flow.StaveTie = function () {
        ...
        return t.prototype = {
            ...
            setNotes: function (t) {
                ...
                if (t.first_indices || (t.first_indices = [0]), t.last_indices || (t.last_indices = [0]), t.first_indices.length != t.last_indices.length)
            ...
            renderTie: function (t) {
                if (0 === t.first_ys.length || 0 === t.last_ys.length)
                    throw new Vex.RERR('BadArguments', 'No Y-values to render');
                var i = this.context, e = this.render_options.cp1, s = this.render_options.cp2;
                ...
                for (var n = this.render_options.first_x_shift, r = this.render_options.last_x_shift, o = this.render_options.y_shift * t.direction, _ = 0; _ < this.first_indices.length; ++_) {
                    var h = (t.last_x_px + r + (t.first_x_px + n)) / 2, a = t.first_ys[this.first_indices[_]] + o, f = t.last_ys[this.last_indices[_]] + o;
                    if (isNaN(a) || isNaN(f))
                        throw new Vex.RERR('BadArguments', 'Bad indices for tie rendering.');
                    var c = (a + f) / 2 + e * t.direction, x = (a + f) / 2 + s * t.direction;
            ...
            draw: function () {
                ...
                var t, i, e, s, n, r = this.first_note, o = this.last_note;
    ...
    Vex.Flow.TabTie = function () {
        ...
        return t.createHammeron = function (e) {
            ...
            draw: function () {
                if (!this.context)
                    throw new Vex.RERR('NoContext', 'No context to render tie.');
                var t, e, i, n, s = this.first_note, r = this.last_note;
        ...
        return t.SLIDE_UP = 1, t.SLIDE_DOWN = -1, t.createSlideUp = function (e) {
            ...
            init: function (e, i) {
                if (t.superclass.init.call(this, e, 'sl.'), !i) {
                    var n = e.first_note.getPositions()[0].fret, s = e.last_note.getPositions()[0].fret;
                    i = parseInt(n, 10) > parseInt(s, 10) ? t.SLIDE_DOWN : t.SLIDE_UP;
                }
                this.slide_direction = i, this.render_options.cp1 = 11, this.render_options.cp2 = 14, this.render_options.y_shift = 0.5, this.setFont({
                    font: 'Times',
                    size: 10,
                    style: 'bold italic'
                }), this.setNotes(e);
            ...
            renderTie: function (e) {
                if (0 === e.first_ys.length || 0 === e.last_ys.length)
                    throw new Vex.RERR('BadArguments', 'No Y-values to render');
                var i = this.context, n = e.first_x_px, s = e.first_ys, r = e.last_x_px, o = this.slide_direction;
                if (o != t.SLIDE_UP && o != t.SLIDE_DOWN)
    ...
    Vex.Flow.Vibrato = function () {
        ...
        return Vex.Inherit(t, i, {
            ...
            draw: function () {
                function t(t, i) {
                    var n = e.render_options.wave_width, h = e.render_options.wave_girth, a = e.render_options.wave_height, s = r / n;
                    o.beginPath();
                    var d;
                    if (e.harsh) {
                        for (o.moveTo(t, i + h + 1), d = 0; s / 2 > d; ++d)
                            o.lineTo(t + n, i - a / 2), t += n, o.lineTo(t + n, i + a / 2), t += n;
                        for (d = 0; s / 2 > d; ++d)
                            o.lineTo(t - n, i - a / 2 + h + 1), t -= n, o.lineTo(t - n, i + a / 2 + h + 1), t -= n;
                        o.fill();
                    } else {
                        for (o.moveTo(t, i + h), d = 0; s / 2 > d; ++d)
                            o.quadraticCurveTo(t + n / 2, i - a / 2, t + n, i), t += n, o.quadraticCurveTo(t + n / 2, i + a / 2, t + n, i), t += n;
                        for (d = 0; s / 2 > d; ++d)
                            o.quadraticCurveTo(t - n / 2, i + a / 2 + h, t - n, i + h), t -= n, o.quadraticCurveTo(t - n / 2, i - a / 2 + h, t - n, i + h), t -= n;
                        o.fill();
                    }
                }
                if (!this.context)
                ...
                var i = this.note.getModifierStartXY(Vex.Flow.Modifier.Position.RIGHT, this.index), o = this.context, e = this, r = this.vibrato_width, n = i.x + this.x_shift, h = this.note.getYForTopText(this.text_line) + 2;
                t(n, h);
            }
        }), t;
    }();
    Vex.Flow.Annotation = function () {
        ...
        function i() {
            t.DEBUG && Vex.L('Vex.Flow.Annotation', arguments);
        }
        t.Justify = {
            LEFT: 1,
            CENTER: 2,
        ...
        return Vex.Inherit(t, e, {
            ...
            draw: function () {
                ...
                var n = this.note.getModifierStartXY(e.Position.ABOVE, this.index);
                this.context.save(), this.context.setFont(this.font.family, this.font.size, this.font.weight);
                var s, o, h = this.context.measureText(this.text).width, a = this.context.measureText('m').width;
                s = this.justification == t.Justify.LEFT ? n.x : this.justification == t.Justify.RIGHT ? n.x - h : this.justification == t.Justify.CENTER ? n.x - h / 2 : this.note.getStemX() - h / 2;
                var r, f, u = this.note.hasStem(), x = this.note.getStave();
                if (u && (r = this.note.getStem().getExtents(), f = x.getSpacingBetweenLines()), this.vert_justification == t.VerticalJustify.BOTTOM) {
                    if (o = x.getYForBottomText(this.text_line), u) {
                        var c = 1 === this.note.getStemDirection() ? r.baseY : r.topY;
                        o = Math.max(o, c + f * (this.text_line + 2));
                    }
                } else if (this.vert_justification == t.VerticalJustify.CENTER) {
                    var l = this.note.getYForTopText(this.text_line) - 1, T = x.getYForBottomText(this.text_line);
                    o = l + (T - l) / 2 + a / 2;
                } else if (this.vert_justification == t.VerticalJustify.TOP)
                    o = Math.min(x.getYForTopText(this.text_line), this.note.getYs()[0] - 10), u && (o = Math.min(o, r.topY - 5 - f * this.text_line));
                else {
                    var g = this.note.getStemExtents();
                    o = g.topY + (g.baseY - g.topY) / 2 + a / 2;
                }
                i('Rendering annotation: ', this.text, s, o), this.context.fillText(this.text, s, o), this.context.restore();
            }
        }), t;
    }();
    Vex.Flow.Articulation = function () {
        ...
        function i() {
            t.DEBUG && Vex.L('Vex.Flow.Articulation', arguments);
        }
        var e = Vex.Flow.Modifier;
        return Vex.Inherit(t, e, {
            init: function (i) {
                if (t.superclass.init.call(this), this.note = null, this.index = null, this.type = i, this.position = e.Position.BELOW, this.render_options = { font_scale: 38 }, this.articulation = Vex.Flow.articulationCodes(this.type), !this.articulation)
            ...
            draw: function () {
                ...
                var t = this.note.getStemDirection(), o = this.note.getStave(), n = this.position === e.Position.ABOVE && t === Vex.Flow.StaveNote.STEM_DOWN || this.position === e.Position.BELOW && t === Vex.Flow.StaveNote.STEM_UP, s = function (t, i, o) {
                        var s = t.position === e.Position.ABOVE ? 1 : -1, a = t.getNote().getDuration();
                        n || 'w' === a || '1' === a || (i += 3.5 * s);
                        var h = i + s * o;
                        return h >= 1 && 5 >= h && 0 === h % 1 ? !0 : !1;
                    }, a = this.note.getModifierStartXY(this.position, this.index), h = a.y, r = 0, l = 1, u = o.getSpacingBetweenLines(), x = 'tabnotes' === this.note.getCategory(), c = this.note.getStem().getExtents(), w = c.topY, g = c.baseY;
                t === Vex.Flow.StaveNote.STEM_DOWN && (w = c.baseY, g = c.topY), x && (this.note.hasStem() ? t === Vex.Flow.StaveNote.STEM_UP ? g = o.getYForBottomText(this.text_line - 2) : t === Vex.Flow.StaveNote.STEM_DOWN && (w = o.getYForTopText(this.text_line - 1.5)) : (w = o.getYForTopText(this.text_line - 1), g = o.getYForBottomText(this.text_line - 2)));
                var _ = this.position === e.Position.ABOVE ? !0 : !1, d = this.note.getLineNumber(_);
                !n && this.note.beam && (l += 0.5), s(this, d, l) && (l += 0.5);
                var p;
                this.position === e.Position.ABOVE ? (r = this.articulation.shift_up, p = w - 7 - u * (this.text_line + l), h = this.articulation.between_lines ? p : Math.min(o.getYForTopText(this.text_line) - 3, p)) : (r = this.articulation.shift_down - 10, p = g + 10 + u * (this.text_line + l), h = this.articulation.between_lines ? p : Math.max(o.getYForBottomText(this.text_line), p));
                var f = a.x + this.articulation.shift_right;
                h += r + this.y_shift, i('Rendering articulation: ', this.articulation, f, h), Vex.Flow.renderGlyph(this.context, f, h, this.render_options.font_scale, this.articulation.code);
            }
        }), t;
    }();
    Vex.Flow.Tuning = function () {
        ...
        return n.names = {
            ...
            init: function (n) {
                this.setTuning(n || 'E/5,B/4,G/4,D/4,A/3,E/3,B/2,E/2');
            },
            ...
            setTuning: function (n) {
                ...
                var t = n.split(/\s*,\s*/);
                if (0 === t.length)
                    throw new Vex.RERR('BadArguments', 'Invalid tuning string: ' + n);
                this.numStrings = t.length;
                for (var e = 0; e < this.numStrings; ++e)
                    this.tuningValues[e] = this.noteToInteger(t[e]);
            },
            getValueForString: function (n) {
                var t = parseInt(n, 10);
                if (1 > t || t > this.numStrings)
                    throw new Vex.RERR('BadArguments', 'String number must be between 1 and ' + this.numStrings + ': ' + n);
                return this.tuningValues[t - 1];
            },
            getValueForFret: function (n, t) {
                var e = this.getValueForString(t), r = parseInt(n, 10);
                if (0 > r)
                    throw new Vex.RERR('BadArguments', 'Fret number must be 0 or higher: ' + n);
                return e + r;
            },
            getNoteForFret: function (n, t) {
                var e = this.getValueForFret(n, t), r = Math.floor(e / 12), i = e % 12;
        ...
        return Vex.Inherit(t, Vex.Flow.StaveModifier, {
            ...
            addModifier: function (t) {
                ...
                for (var i = 0; i < this.accList.length; ++i)
                    this.addAccToStave(t, this.accList[i]);
            },
            ...
            convertAccLines: function (t, i) {
                ...
                if (n)
                    for (e = [
                            ...
                            0,
                            1.5
                        ], s = 0; s < this.accList.length; ++s)
                        this.accList[s].line = e[s];
                else if ('treble' != t)
                    for (s = 0; s < this.accList.length; ++s)
                        this.accList[s].line += c;
            }
        }), t;
    }();
        ...
        return i.glyphs = {
            ...
            parseTimeSpec: function (t) {
                ...
                for (n = 0; n < t.length && (h = t.charAt(n), '/' != h); ++n) {
                    if (!/[0-9]/.test(h))
                        throw new Vex.RERR('BadTimeSignature', 'Invalid time spec: ' + t);
                    s.push(h);
                }
                if (0 === n)
                    throw new Vex.RERR('BadTimeSignature', 'Invalid time spec: ' + t);
            ...
            makeTimeSignatureGlyph: function (i, t) {
                ...
                var p = s > l ? s : l, a = e.getMetrics().x_min;
                ...
                var g = (p - s) / 2, m = (p - l) / 2, c = this;
                return e.renderToStave = function (i) {
                    var t, e, n = i + g;
                    for (t = 0; t < this.topGlyphs.length; ++t)
                        e = this.topGlyphs[t], Vex.Flow.Glyph.renderOutline(this.context, e.metrics.outline, e.scale, n + e.x_shift, this.stave.getYForLine(c.topLine) + 1), n += e.getMetrics().width;
                    for (n = i + m, t = 0; t < this.botGlyphs.length; ++t)
                        e = this.botGlyphs[t], c.placeGlyphOnLine(e, this.stave, e.line), Vex.Flow.Glyph.renderOutline(this.context, e.metrics.outline, e.scale, n + e.x_shift, this.stave.getYForLine(c.bottomLine) + 1), n += e.getMetrics().width;
                }, e;
            },
            getTimeSig: function () {
                return this.timeSig;
    ...
    Vex.Flow.Clef = function () {
        ...
        function n() {
            Vex.Flow.Clef.DEBUG && Vex.L('Vex.Flow.Clef', arguments);
        }
        return e.types = {
            treble: {
                code: 'v83',
            ...
            init: function (e) {
                ...
                i.init.call(this), this.clef = Vex.Flow.Clef.types[e], n('Creating clef:', e);
            },
            addModifier: function (e) {
                var n = new Vex.Flow.Glyph(this.clef.code, this.clef.point);
                this.placeGlyphOnLine(n, e, this.clef.line), e.addGlyph(n);
            },
            addEndModifier: function (e) {
                var n = new Vex.Flow.Glyph(this.clef.code, this.clef.point);
                this.placeGlyphOnLine(n, e, this.clef.line), e.addEndGlyph(n);
            }
        }), e;
    }();
    Vex.Flow.Music = function () {
        ...
        return n.NUM_TONES = 12, n.roots = [
            ...
            getNoteParts: function (n) {
                ...
                if (n.length > 3)
                    throw new Vex.RERR('BadArguments', 'Invalid note name: ' + n);
                var t = n.toLowerCase(), e = /^([cdefgab])(b|bb|n|#|##)?$/, a = e.exec(t);
                if (null != a) {
                    var i = a[1], o = a[2];
                    return {
                        root: i,
            ...
            getKeyParts: function (n) {
                ...
                var t = n.toLowerCase(), e = /^([cdefgab])(b|#)?(mel|harm|m|M)?$/, a = e.exec(t);
                if (null != a) {
                    var i = a[1], o = a[2], r = a[3];
                    return r || (r = 'M'), {
                        root: i,
                        accidental: o,
                        type: r
            ...
            getNoteValue: function (t) {
                ...
                if (null == e)
                    throw new Vex.RERR('BadArguments', 'Invalid note name: ' + t);
                return e.int_val;
            },
            getIntervalValue: function (t) {
                var e = n.intervals[t];
                if (null == e)
                    throw new Vex.RERR('BadArguments', 'Invalid interval name: ' + t);
                return e;
            },
            getCanonicalNoteName: function (t) {
                if (!this.isValidNoteValue(t))
                    throw new Vex.RERR('BadArguments', 'Invalid note value: ' + t);
                return n.canonical_notes[t];
            },
            getCanonicalIntervalName: function (t) {
                if (!this.isValidIntervalValue(t))
                    throw new Vex.RERR('BadArguments', 'Invalid interval value: ' + t);
                return n.diatonic_intervals[t];
            },
            getRelativeNoteValue: function (t, e, a) {
                if (null == a && (a = 1), 1 != a && -1 != a)
                    throw new Vex.RERR('BadArguments', 'Invalid direction: ' + a);
                var i = (t + a * e) % n.NUM_TONES;
                return 0 > i && (i += n.NUM_TONES), i;
            },
            getRelativeNoteName: function (t, e) {
                var a = this.getNoteParts(t), i = this.getNoteValue(a.root), o = e - i;
                if (Math.abs(o) > n.NUM_TONES - 3) {
                    var r = 1;
                    o > 0 && (r = -1);
                    var l = (e + 1 + (i + 1)) % n.NUM_TONES * r;
                    if (Math.abs(l) > 2)
                        throw new Vex.RERR('BadArguments', 'Notes not related: ' + t + ', ' + e);
                    o = l;
                }
                if (Math.abs(o) > 2)
                    throw new Vex.RERR('BadArguments', 'Notes not related: ' + t + ', ' + e);
            ...
            getScaleTones: function (n, t) {
                ...
                for (var a = n, i = 0; i < t.length; ++i)
                    a = this.getRelativeNoteValue(a, t[i]), a != n && e.push(a);
                return e;
            },
            getIntervalBetween: function (t, e, a) {
                ...
                if (!this.isValidNoteValue(t) || !this.isValidNoteValue(e))
                    throw new Vex.RERR('BadArguments', 'Invalid notes: ' + t + ', ' + e);
                var i;
        ...
        return t.scales = {
            ...
            reset: function () {
                ...
                for (var s = Vex.Flow.Music.root_indices[this.keyParts.root], a = 0; a < Vex.Flow.Music.roots.length; ++a) {
                    var i = (s + a) % Vex.Flow.Music.roots.length, c = Vex.Flow.Music.roots[i], l = this.music.getRelativeNoteName(c, this.scale[a]);
            ...
            getAccidental: function (t) {
                var e = this.music.getKeyParts(t).root, s = this.music.getNoteParts(this.scaleMap[e]);
                return {
            ...
            selectNote: function (t) {
                t = t.toLowerCase();
                var e = this.music.getNoteParts(t), s = this.scaleMap[e.root], a = this.music.getNoteParts(s);
                if (s == t)
                    return {
                        note: s,
    ...
    Vex.Flow.Renderer = function () {
        ...
        return e.Backends = {
            ...
            UP: 2,
            DOWN: 3
        }, e.USE_CANVAS_PROXY = !1, e.buildContext = function (t, n, a, i, o) {
            var s = new e(t, n);
            a && i && s.resize(a, i), o || (o = '#eed');
            var r = s.getContext();
            return r.setBackgroundFillStyle(o), r;
        }, e.getCanvasContext = function (t, n, a, i) {
            return e.buildContext(t, e.Backends.CANVAS, n, a, i);
        }, e.getRaphaelContext = function (t, n, a, i) {
            return e.buildContext(t, e.Backends.RAPHAEL, n, a, i);
        }, e.bolsterCanvasContext = function (t) {
            if (e.USE_CANVAS_PROXY)
                return new Vex.Flow.CanvasContext(t);
            var n = [
                    'clear',
                    'setFont',
                    'setRawFont',
            ...
            for (var a in n) {
                var i = n[a];
                t[i] = Vex.Flow.CanvasContext.prototype[i];
            }
            return t;
        }, e.drawDashedLine = function (e, t, n, a, i, o) {
            e.beginPath();
            var s = a - t, r = i - n, l = Math.atan2(r, s), h = t, c = n;
            e.moveTo(t, n);
            for (var d = 0, x = !0; !(0 > s ? a >= h : h >= a) || !(0 > r ? i >= c : c >= i);) {
                var C = o[d++ % o.length], u = h + Math.cos(l) * C;
                h = 0 > s ? Math.max(a, u) : Math.min(a, u);
                var m = c + Math.sin(l) * C;
                c = 0 > r ? Math.max(i, m) : Math.min(i, m), x ? e.lineTo(h, c) : e.moveTo(h, c), x = !x;
            }
            e.closePath(), e.stroke();
        }, e.prototype = {
            init: function (t, n) {
                if (this.sel = t, !this.sel)
                ...
                if (this.element = document.getElementById(t), this.element || (this.element = t), this.ctx = null, this.paper = null, this.backend = n, this.backend == e.Backends.CANVAS) {
                    if (!this.element.getContext)
                        throw new Vex.RERR('BadElement', 'Can\'t get canvas context from element: ' + t);
                    this.ctx = e.bolsterCanvasContext(this.element.getContext('2d'));
                } else {
                    if (this.backend != e.Backends.RAPHAEL)
    ...
    Vex.Flow.RaphaelContext = function () {
        ...
        return t.prototype = {
            ...
            rect: function (t, i, s, e) {
                return 0 > e && (i += e, e = -e), this.paper.rect(t, i, s - 0.5, e - 0.5).attr(this.attributes).attr('fill', 'none').attr('stroke-width', this.lineWidth), this;
            },
            fillRect: function (t, i, s, e) {
                return 0 > e && (i += e, e = -e), this.paper.rect(t, i, s - 0.5, e - 0.5).attr(this.attributes), this;
            },
            clearRect: function (t, i, s, e) {
                return 0 > e && (i += e, e = -e), this.paper.rect(t, i, s - 0.5, e - 0.5).attr(this.background_attributes), this;
            },
            beginPath: function () {
    ...
    Vex.Flow.CanvasContext = function () {
        ...
        return t.WIDTH = 600, t.HEIGHT = 400, t.prototype = {
            ...
            setLineDash: function (t) {
                this.vexFlowCanvasContext.lineDash = t;
            },
            scale: function (t, n) {
    ...
    Vex.Flow.Barline = function () {
        ...
        return Vex.Inherit(t, Vex.Flow.StaveModifier, {
            ...
            drawVerticalBar: function (t, n, a) {
                if (!t.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw stave without canvas context.');
                var i = t.getYForLine(0), r = t.getYForLine(t.options.num_lines - 1) + e / 2;
                a && t.context.fillRect(n - 3, i, 1, r - i + 1), t.context.fillRect(n, i, 1, r - i + 1);
            },
            drawVerticalEndBar: function (t, n) {
                if (!t.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw stave without canvas context.');
                var a = t.getYForLine(0), i = t.getYForLine(t.options.num_lines - 1) + e / 2;
                t.context.fillRect(n - 5, a, 1, i - a + 1), t.context.fillRect(n - 2, a, 3, i - a + 1);
            },
            drawRepeatBar: function (t, n, a) {
                if (!t.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw stave without canvas context.');
                var i = t.getYForLine(0), r = t.getYForLine(t.options.num_lines - 1) + e / 2, o = 3;
                a || (o = -5), t.context.fillRect(n + o, i, 1, r - i + 1), t.context.fillRect(n - 2, i, 3, r - i + 1);
                var s = 2;
                a ? o += 4 : o -= 4;
                var c = n + o + s / 2, x = (t.options.num_lines - 1) * t.options.spacing_between_lines_px;
    ...
    Vex.Flow.StaveHairpin = function () {
        ...
        return t.type = {
            ...
            var _ = h * r.left_shift_ticks, f = h * r.right_shift_ticks, a = {
                    height: r.height,
                    y_shift: r.y_shift,
                    left_shift_px: _,
                    right_shift_px: f
            ...
            renderHairpin: function (i) {
                var e = this.context, s = this.render_options.y_shift + 20, n = i.first_y;
                this.position == Vex.Flow.Modifier.Position.ABOVE && (s = -s + 30, n = i.first_y - i.staff_height);
                var o = this.render_options.left_shift_px, r = this.render_options.right_shift_px;
                switch (this.hairpin) {
                case t.type.CRESC:
            ...
            draw: function () {
                ...
                var t = this.first_note, i = this.last_note, e = t.getModifierStartXY(this.position, 0), s = i.getModifierStartXY(this.position, 0);
    ...
    Vex.Flow.Volta = function () {
        ...
        return t.type = {
            ...
            draw: function (i, e) {
                if (!i.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw stave without canvas context.');
                var s = i.context, n = i.width, o = i.getYForTopText(i.options.num_lines) + this.y_shift, h = 1.5 * i.options.spacing_between_lines_px;
                switch (this.volta) {
    ...
    Vex.Flow.Repetition = function () {
        ...
        return t.type = {
            ...
            drawSymbolText: function (t, e, i, s) {
                ...
                var a = 0 + this.x_shift, o = e + this.x_shift;
    ...
    Vex.Flow.StaveSection = function () {
        ...
        return Vex.Inherit(t, i, {
            ...
            draw: function (t, i) {
                ...
                var s = e.measureText('' + this.section).width, n = s + 6;
                18 > n && (n = 18);
                var h = 20, o = t.getYForTopText(3) + this.shift_y, r = this.x + i;
    ...
    Vex.Flow.StaveTempo = function () {
        ...
        return Vex.Inherit(t, Vex.Flow.StaveModifier, {
            ...
            draw: function (t, e) {
                ...
                var i = this.render_options, o = i.glyph_font_scale / 38, s = this.tempo.name, n = this.tempo.duration, h = this.tempo.dots, r = this.tempo.bpm, a = this.font, f = t.context, l = this.x + this.shift_x + e, m = t.getYForTopText(1) + this.shift_y;
                if (f.save(), s && (f.setFont(a.family, a.size, a.weight), f.fillText(s, l, m), l += f.measureText(s).width), n && r) {
                    ...
                    for (var c = 0; h > c; c++)
                        l += 6 * o, f.beginPath(), f.arc(l, m + 2 * o, 2 * o, 0, 2 * Math.PI, !1), f.fill();
    ...
    Vex.Flow.StaveText = function () {
        ...
        return Vex.Inherit(t, i, {
            init: function (i, e, o) {
                t.superclass.init.call(this), this.setWidth(16), this.text = i, this.position = e, this.options = {
                    shift_x: 0,
                    shift_y: 0,
                    justification: Vex.Flow.TextNote.Justification.CENTER
                }, Vex.Merge(this.options, o), this.font = {
                    family: 'times',
                    size: 16,
                    weight: 'normal'
                };
            ...
            draw: function (t) {
                ...
                var i = t.context;
                i.save(), i.lineWidth = 2, i.setFont(this.font.family, this.font.size, this.font.weight);
                var e, o, s = i.measureText('' + this.text).width, n = Vex.Flow.Modifier;
                switch (this.position) {
                case n.Position.LEFT:
                case n.Position.RIGHT:
                    o = (t.getYForLine(0) + t.getBottomLineY()) / 2 + this.options.shift_y, e = this.position == n.Position.LEFT ? t.getX() - s - 24 + this.options.shift_x : t.getX() + t.getWidth() + 24 + this.options.shift_x;
                    break;
                case n.Position.ABOVE:
                case n.Position.BELOW:
                    var h = Vex.Flow.TextNote.Justification;
                    e = t.getX() + this.options.shift_x, this.options.justification == h.CENTER ? e += t.getWidth() / 2 - s / 2 : this.options.justification == h.RIGHT && (e += t.getWidth() - s), o = this.position == n.Position.ABOVE ? t.getYForTopText(2) + this.options.shift_y : t.getYForBottomText(2) + this.options.shift_y;
                    break;
                default:
                    throw new Vex.RERR('InvalidPosition', 'Value Must be in Modifier.Position.');
                }
                return i.fillText('' + this.text, e, o + 4), i.restore(), this;
            }
        }), t;
    }();
    Vex.Flow.BarNote = function () {
        ...
        function i() {
            t.DEBUG && Vex.L('Vex.Flow.BarNote', arguments);
        }
        return Vex.Inherit(t, Vex.Flow.Note, {
            init: function () {
                t.superclass.init.call(this, { duration: 'b' });
                var i = Vex.Flow.Barline.type;
                this.metrics = { widths: {} }, this.metrics.widths[i.SINGLE] = 8, this.metrics.widths[i.DOUBLE] = 12, this.metrics.widths[i.END] = 15, this.metrics.widths[i.REPEAT_BEGIN] = 14, this.metrics.widths[i.REPEAT_END] = 14, this.metrics.widths[i.REPEAT_BOTH] = 18, this.metrics.widths[i.NONE] = 0, this.ignore_ticks = !0, this.type = i.SINGLE, this.setWidth(this.metrics.widths[this.type]);
            },
            getType: function () {
                return this.type;
            },
            ...
            draw: function () {
                if (!this.stave)
                    throw new Vex.RERR('NoStave', 'Can\'t draw without a stave.');
                i('Rendering bar line at: ', this.getAbsoluteX());
    ...
    Vex.Flow.Tremolo = function () {
        ...
        return Vex.Inherit(t, i, {
            ...
            draw: function () {
                ...
                var t = this.note.getModifierStartXY(this.position, this.index), i = t.x, n = t.y;
                i += this.shift_right;
                for (var o = 0; o < this.num; ++o)
                    Vex.Flow.renderGlyph(this.context, i, n, this.render_options.font_scale, this.code), n += this.y_spacing;
            }
        }), t;
    }();
    Vex.Flow.Tuplet = function () {
        ...
        return t.LOCATION_TOP = 1, t.LOCATION_BOTTOM = -1, t.prototype = {
            ...
            setTupletLocation: function (s) {
                if (s) {
                    if (s != t.LOCATION_TOP && s != t.LOCATION_BOTTOM)
                        throw new Vex.RERR('BadArgument', 'Invalid tuplet location: ' + s);
                } else
                    s = t.LOCATION_TOP;
            ...
            resolveGlyphs: function () {
                this.num_glyphs = [];
                for (var t = this.num_notes; t >= 1;)
                    this.num_glyphs.push(new Vex.Flow.Glyph('v' + t % 10, this.point)), t = parseInt(t / 10, 10);
                for (this.denom_glyphs = [], t = this.beats_occupied; t >= 1;)
                    this.denom_glyphs.push(new Vex.Flow.Glyph('v' + t % 10, this.point)), t = parseInt(t / 10, 10);
            },
            draw: function () {
                if (!this.context)
                    throw new Vex.RERR('NoCanvasContext', 'Can\'t draw without a canvas context.');
                var s = this.notes[0], i = this.notes[this.notes.length - 1];
                ...
                var n, r = 0;
                for (n in this.num_glyphs)
                    r += this.num_glyphs[n].getMetrics().width;
                if (this.ratioed) {
                    for (n in this.denom_glyphs)
                        r += this.denom_glyphs[n].getMetrics().width;
                    r += 0.32 * this.point;
                }
                var p = this.x_pos + this.width / 2, c = p - r / 2;
                if (this.bracketed) {
                ...
                var l = 0, u = this.num_glyphs.length;
                for (n in this.num_glyphs)
                    this.num_glyphs[u - n - 1].render(this.context, c + l, this.y_pos + this.point / 3 - 2), l += this.num_glyphs[u - n - 1].getMetrics().width;
                if (this.ratioed) {
                    var _ = c + l + 0.16 * this.point, g = 0.06 * this.point;
                    this.context.beginPath(), this.context.arc(_, this.y_pos - 0.08 * this.point, g, 0, 2 * Math.PI, !0), this.context.closePath(), this.context.fill(), this.context.beginPath(), this.context.arc(_, this.y_pos + 0.12 * this.point, g, 0, 2 * Math.PI, !0), this.context.closePath(), this.context.fill(), l += 0.32 * this.point, u = this.denom_glyphs.length;
                    for (n in this.denom_glyphs)
                        this.denom_glyphs[u - n - 1].render(this.context, c + l, this.y_pos + this.point / 3 - 2), l += this.denom_glyphs[u - n - 1].getMetrics().width;
                }
            }
        }, t;
    }();
    Vex.Flow.BoundingBox = function () {
        ...
        return t.copy = function (i) {
            return new t(i.x, i.y, i.w, i.h);
        }, t.prototype = {
            init: function (t, i, h, n) {
                this.x = t, this.y = i, this.w = h, this.h = n;
            },
            getX: function () {
                return this.x;
            },
            ...
            mergeWith: function (t, i) {
                var h = t, n = this.x < h.x ? this.x : h.x, s = this.y < h.y ? this.y : h.y, e = this.x + this.w < h.x + h.w ? h.x + h.w - this.x : this.x + this.w - Vex.Min(this.x, h.x), r = this.y + this.h < h.y + h.h ? h.y + h.h - this.y : this.y + this.h - Vex.Min(this.y, h.y);
                return this.x = n, this.y = s, this.w = e, this.h = r, i && this.draw(i), this;
            },
            draw: function (t, i, h) {
                i || (i = 0), h || (h = 0), t.rect(this.x + i, this.y + h, this.w, this.h), t.stroke();
            }
        }, t;
    }();
    Vex.Flow.TextNote = function () {
        ...
        return t.Justification = {
            ...
            init: function (i) {
                if (t.superclass.init.call(this, i), this.text = i.text, this.superscript = i.superscript, this.subscript = i.subscript, this.glyph_type = i.glyph, this.glyph = null, this.font = {
                        family: 'Arial',
                        size: 12,
                        weight: ''
                    ...
                    this.glyph = new Vex.Flow.Glyph(s.code, s.point, { cache: !1 }), s.width ? this.setWidth(s.width) : this.setWidth(this.glyph.getMetrics().width), this.glyph_struct = s;
                } else
            ...
            draw: function () {
                ...
                if (!this.stave)
                    throw new Vex.RERR('NoStave', 'Can\'t draw without a stave.');
                var i = this.context, s = this.getAbsoluteX();
                this.justification == t.Justification.CENTER ? s -= this.getWidth() / 2 : this.justification == t.Justification.RIGHT && (s -= this.getWidth());
                var e;
                if (this.glyph)
                    e = this.stave.getYForLine(this.line + -3), this.glyph.render(this.context, s + this.glyph_struct.x_shift, e + this.glyph_struct.y_shift);
                else {
                    e = this.stave.getYForLine(this.line + -3), i.save(), i.setFont(this.font.family, this.font.size, this.font.weight), i.fillText(this.text, s, e);
                    var h = i.measureText('M').width, o = i.measureText(this.text).width;
                    this.superscript && (i.setFont(this.font.family, this.font.size / 1.3, this.font.weight), i.fillText(this.superscript, s + o + 2, e - h / 2.2)), this.subscript && (i.setFont(this.font.family, this.font.size / 1.3, this.font.weight), i.fillText(this.subscript, s + o + 2, e + h / 2.2 - 1)), i.restore();
                }
            }
        }), t;
    }();
    Vex.Flow.FretHandFinger = function () {
        ...
        return Vex.Inherit(t, i, {
            ...
            draw: function () {
                ...
                var t = this.context, n = this.note.getModifierStartXY(this.position, this.index), e = n.x + this.x_shift + this.x_offset, s = n.y + this.y_shift + this.y_offset + 5;
                switch (this.position) {
    ...
    Vex.Flow.StringNumber = function () {
        ...
        return Vex.Inherit(t, e, {
            ...
            draw: function () {
                ...
                if (!this.note || null == this.index)
                    throw new Vex.RERR('NoAttachedNote', 'Can\'t draw string number without a note and index.');
                var t = this.context, i = this.note.stave.options.spacing_between_lines_px, s = this.note.getModifierStartXY(this.position, this.index), n = s.x + this.x_shift + this.x_offset, o = s.y + this.y_shift + this.y_offset;
                switch (this.position) {
                case e.Position.ABOVE:
                case e.Position.BELOW:
                    var h = this.note.getStemExtents(), r = h.topY, a = h.baseY + 2;
                ...
                if (t.fillText('' + this.string_number, d, o + 4.5), null != this.last_note) {
                    ...
                    t.strokeStyle = '#000000', t.lineCap = 'round', t.lineWidth = 0.6, this.dashed ? Vex.Flow.Renderer.drawDashedLine(t, n + 10, o, n + u, o, [
                        3,
                        3
                    ]) : Vex.Flow.Renderer.drawDashedLine(t, n + 10, o, n + u, o, [
                        3,
                        0
                    ]);
                    var f, l;
                    ...
                    case Vex.Flow.Renderer.LineEndType.UP:
                        f = -10, l = this.dashed ? [
                            ...
                            3,
                            0
                        ], Vex.Flow.Renderer.drawDashedLine(t, n + u, o, n + u, o + f, l);
                        break;
    ...
    Vex.Flow.Stroke = function () {
        ...
        return Vex.Inherit(t, e, {
            ...
            draw: function () {
                ...
                var e, i = this.note.getModifierStartXY(this.position, this.index), s = this.note.getYs(), o = i.y, n = i.y, h = i.x - 5, r = this.note.stave.options.spacing_between_lines_px, a = this.getModifierContext().getModifiers(this.note.getCategory());
                for (e = 0; e < a.length; e++) {
                    s = a[e].getYs();
                    for (var l = 0; l < s.length; l++)
                        (this.note == a[e] || this.all_voices) && (o = Vex.Min(o, s[l]), n = Vex.Max(n, s[l]));
                }
                var c, f, x, _, p;
                switch (this.type) {
                ...
                case t.Type.BRUSH_UP:
                    c = 'v11', f = 0.5, x = n + r / 2, o -= r / 2;
                    break;
                case t.Type.ROLL_DOWN:
                case t.Type.RASQUEDO_DOWN:
                    c = 'vc3', f = -3, _ = this.x_shift + f - 2, this.note instanceof Vex.Flow.StaveNote ? (o += 1.5 * r, n += 0 !== (n - o) % 2 ? 0.5 * r : r, x = o - r, p = n + r + 2) : (o += 1.5 * r, n += r, x = o - 0.75 * r, p = n + 0.25 * r);
                    break;
                case t.Type.ROLL_UP:
                case t.Type.RASQUEDO_UP:
                    c = 'v52', f = -4, _ = this.x_shift + f - 1, this.note instanceof Vex.Flow.StaveNote ? (x = r / 2, o += 0.5 * r, 0 === (n - o) % 2 && (n += r / 2), x = n + 0.5 * r, p = o - 1.25 * r) : (o += 0.25 * r, n += 0.5 * r, x = n + 0.25 * r, p = o - r);
                }
                if (this.type == t.Type.BRUSH_DOWN || this.type == t.Type.BRUSH_UP)
                    this.context.fillRect(h + this.x_shift, o, 1, n - o);
                else if (this.note instanceof Vex.Flow.StaveNote)
                    for (e = o; n >= e; e += r)
                        Vex.Flow.renderGlyph(this.context, h + this.x_shift - 4, e, this.render_options.font_scale, 'va3');
                else {
                    for (e = o; n >= e; e += 10)
                        Vex.Flow.renderGlyph(this.context, h + this.x_shift - 4, e, this.render_options.font_scale, 'va3');
                    this.type == Vex.Flow.Stroke.Type.RASQUEDO_DOWN && (p = e + 0.25 * r);
                }
    ...
    Vex.Flow.Curve = function () {
        ...
        return t.Position = {
            ...
            init: function (e, i, n) {
                ...
                }, Vex.Merge(this.render_options, n), this.setNotes(e, i);
            },
            setContext: function (t) {
                return this.context = t, this;
            },
            setNotes: function (t, e) {
                if (!t && !e)
            ...
            renderCurve: function (t) {
                var e = this.context, i = this.render_options.cps, n = this.render_options.x_shift, o = this.render_options.y_shift * t.direction, s = t.first_x + n, r = t.first_y + o, h = t.last_x - n, _ = t.last_y + o, c = this.render_options.thickness, x = (h - s) / (i.length + 2);
                e.beginPath(), e.moveTo(s, r), e.bezierCurveTo(s + x + i[0].x, r + i[0].y * t.direction, h - x + i[1].x, _ + i[1].y * t.direction, h, _), e.bezierCurveTo(h - x + i[1].x, _ + (i[1].y + c) * t.direction, s + x + i[0].x, r + (i[0].y + c) * t.direction, s, r), e.stroke(), e.closePath(), e.fill();
            },
            draw: function () {
                if (!this.context)
                    throw new Vex.RERR('NoContext', 'No context to render tie.');
                var e, i, n, o, s, r = this.from, h = this.to, _ = 'baseY', c = 'baseY', x = this.render_options.position, f = this.render_options.position_end;
                return x === t.Position.NEAR_TOP && (_ = 'topY', c = 'topY'), f == t.Position.NEAR_HEAD ? c = 'baseY' : f == t.Position.NEAR_TOP && (c = 'topY'), r ? (e = r.getTieRightX(), s = r.getStemDirection(), n = r.getStemExtents()[_]) : (e = h.getStave().getTieStartX(), n = h.getStemExtents()[_]), h ? (i = h.getTieLeftX(), s = h.getStemDirection(), o = h.getStemExtents()[c]) : (i = r.getStave().getTieEndX(), o = r.getStemExtents()[c]), this.renderCurve({
                    first_x: e,
                    last_x: i,
                    first_y: n,
                    last_y: o,
                    direction: s * (this.render_options.invert === !0 ? -1 : 1)
                }), !0;
            }
        }, t;
    }();
    Vex.Flow.StaveLine = function () {
        ...
        function e(t, e, i, n, o, s, r) {
            t.beginPath(), t.moveTo(e, i), t.lineTo(n, o), t.lineTo(s, r), t.lineTo(e, i), t.closePath(), t.fill();
        }
        function i(t, i, n, o) {
            var s, r, a, h, l = o.draw_start_arrow && o.draw_end_arrow, d = i.x, _ = i.y, c = n.x, x = n.y, f = Math.sqrt((c - d) * (c - d) + (x - _) * (x - _)), g = (f - o.arrowhead_length / 3) / f;
            o.draw_end_arrow || l ? (s = Math.round(d + (c - d) * g), r = Math.round(_ + (x - _) * g)) : (s = c, r = x), o.draw_start_arrow || l ? (a = d + (c - d) * (1 - g), h = _ + (x - _) * (1 - g)) : (a = d, h = _), o.color && (t.setStrokeStyle(o.color), t.setFillStyle(o.color)), t.beginPath(), t.moveTo(a, h), t.lineTo(s, r), t.stroke(), t.closePath();
            var w, u, p, T, y, v, M = Math.atan2(x - _, c - d), P = Math.abs(o.arrowhead_length / Math.cos(o.arrowhead_angle));
            (o.draw_end_arrow || l) && (w = M + Math.PI + o.arrowhead_angle, p = c + Math.cos(w) * P, T = x + Math.sin(w) * P, u = M + Math.PI - o.arrowhead_angle, y = c + Math.cos(u) * P, v = x + Math.sin(u) * P, e(t, p, T, c, x, y, v)), (o.draw_start_arrow || l) && (w = M + o.arrowhead_angle, p = d + Math.cos(w) * P, T = _ + Math.sin(w) * P, u = M - o.arrowhead_angle, y = d + Math.cos(u) * P, v = _ + Math.sin(u) * P, e(t, p, T, d, _, y, v));
        }
        return t.TextVerticalPosition = {
            TOP: 1,
            BOTTOM: 2
        }, t.TextJustification = {
            LEFT: 1,
            ...
            init: function (e) {
                this.notes = e, this.context = null, this.text = '', this.font = {
                    family: 'Arial',
                    size: 10,
                    weight: ''
                }, this.render_options = {
                    ...
                    text_position_vertical: t.TextVerticalPosition.TOP,
                    text_justification: t.TextJustification.CENTER
                }, this.setNotes(e);
            },
            setContext: function (t) {
                return this.context = t, this;
            ...
            applyLineStyle: function () {
                ...
                var t = this.render_options, e = this.context;
                t.line_dash && e.setLineDash(t.line_dash), t.line_width && e.setLineWidth(t.line_width), t.rounded_end ? e.setLineCap('round') : e.setLineCap('square');
            },
            ...
            draw: function () {
                ...
                var e = this.context, n = this.first_note, o = this.last_note, s = this.render_options;
                e.save(), this.applyLineStyle();
                var r, a;
                this.first_indices.forEach(function (t, h) {
                    var l = this.last_indices[h];
                    r = n.getModifierStartXY(2, t), a = o.getModifierStartXY(1, l);
                    var d = r.y > a.y;
                    r.x += n.getMetrics().modRightPx + s.padding_left, a.x -= o.getMetrics().modLeftPx + s.padding_right;
                    var _ = n.getGlyph().head_width, c = n.getKeyProps()[t].displaced;
                    c && 1 === n.getStemDirection() && (r.x += _ + s.padding_left);
                    var x = o.getKeyProps()[l].displaced;
                    x && -1 === o.getStemDirection() && (a.x -= _ + s.padding_right), r.y += d ? -3 : 1, a.y += d ? 2 : 0, i(e, r, a, this.render_options);
                }, this), e.restore();
                var h = e.measureText(this.text).width, l = s.text_justification, d = 0;
                if (l === t.TextJustification.LEFT)
                    d = r.x;
                else if (l === t.TextJustification.CENTER) {
                    var _ = a.x - r.x, c = _ / 2 + r.x;
                    d = c - h / 2;
                } else
                    l === t.TextJustification.RIGHT && (d = a.x - h);
                var x, f = s.text_position_vertical;
                return f === t.TextVerticalPosition.TOP ? x = n.getStave().getYForTopText() : f === t.TextVerticalPosition.BOTTOM && (x = n.getStave().getYForBottomText()), e.save(), this.applyFontStyle(), e.fillText(this.text, d, x), e.restore(), this;
            }
        }, t;
    }();
    Vex.Flow.GraceNote = function () {
        ...
        return Vex.Inherit(t, Vex.Flow.StaveNote, {
            init: function (e) {
                t.superclass.init.call(this, e), this.render_options.glyph_font_scale = 22, this.render_options.stem_height = 20, this.render_options.stroke_px = 2, this.glyph.head_width = 6, this.slash = e.slash, this.slur = !0, this.buildNoteHeads(), this.width = 3;
            },
            getStemExtension: function () {
                var t = this.getGlyph();
                return null != this.stem_extension_override ? this.stem_extension_override : t ? 1 === this.getStemDirection() ? t.gracenote_stem_up_extension : t.gracenote_stem_down_extension : 0;
            },
            getCategory: function () {
                return 'gracenotes';
            },
            draw: function () {
                ...
                var e = this.context, i = this.getStemDirection();
                if (this.slash) {
                    e.beginPath();
                    var s = this.getAbsoluteX(), n = this.getYs()[0] - this.stem.getHeight() / 2.8;
                    1 === i ? (s += 1, e.lineTo(s, n), e.lineTo(s + 13, n - 9)) : -1 === i && (s -= 4, n += 1, e.lineTo(s, n), e.lineTo(s + 13, n + 9)), e.closePath(), e.stroke();
                }
            }
        }), t;
    }();
    Vex.Flow.GraceNoteGroup = function () {
        ...
        return Vex.Inherit(t, Vex.Flow.Modifier, {
            init: function (e, i) {
                var n = t.superclass;
                return n.init.call(this), this.note = null, this.index = null, this.position = Vex.Flow.Modifier.Position.LEFT, this.grace_notes = e, this.width = 0, this.preFormatted = !1, this.show_slur = i, this.slur = null, this.formatter = new Vex.Flow.Formatter(), this.voice = new Vex.Flow.Voice({
                    num_beats: 4,
                    beat_value: 4,
                    resolution: Vex.Flow.RESOLUTION
                }).setStrict(!1), this.voice.addTickables(this.grace_notes), this;
            },
            preFormat: function () {
            ...
            beamNotes: function () {
                if (this.grace_notes.length > 1) {
                    var t = new Vex.Flow.Beam(this.grace_notes);
                    t.render_options.beam_width = 3, t.render_options.partial_beam_length = 4, this.beam = t;
                }
                return this;
            },
            setNote: function (t) {
            ...
            draw: function () {
                function t(t, e) {
                    var i = e.getTickContext(), n = i.getExtraPx(), o = i.getX() - n.left - n.extraLeft;
                    t.forEach(function (t) {
                        var i = t.getTickContext(), n = i.getX();
                        t.setStave(e.stave), i.setX(o + n);
                    });
                }
                if (!this.context)
                    throw new Vex.RuntimeError('NoContext', 'Can\'t draw Grace note without a context.');
                var e = this.getNote();
                if (!e || null === this.index)
                    throw new Vex.RuntimeError('NoAttachedNote', 'Can\'t draw grace note without a parent note and parent note index.');
                t(this.grace_notes, e), this.grace_notes.forEach(function (t) {
                    t.setContext(this.context).draw();
                }, this), this.beam && this.beam.setContext(this.context).draw(), this.show_slur && (this.slur = new Vex.Flow.StaveTie({
                    last_note: this.grace_notes[0],
                    first_note: e,
                    first_indices: [0],
                    last_indices: [0]
                }), this.slur.render_options.cp2 = 12, this.slur.setContext(this.context).draw());
            }
        }), t;
    }();
    return Vex;
...
(function () {
    define('services/key_converter', ['lodash'], function (_) {
        var KeyConverter;
...
(function () {
    define('services/midi_service', ['services/key_converter'], function (KeyConverter) {
        var MidiService;
...
(function () {
    define('services/statistic_service', [], function () {
...
!function (a, b) {
    'object' == typeof exports ? module.exports = b() : 'function' == typeof define && define.amd ? define('Chartist', [], b) : a.Chartist = b();
}(this, function () {
    var a = {};
    return a.version = '0.1.10', function (a, b, c) {
        'use strict';
        c.noop = function (a) {
            return a;
            ...
            a = a || {};
            for (var d in b)
                a[d] = 'object' == typeof b[d] ? c.extend(a[d], b[d]) : b[d];
            return a;
        ...
        }, c.createSvg = function (a, d, e) {
            var f, g = a.nodeType ? a : b.querySelector(a);
            if (!g)
                throw 'Container node with selector "' + a + '" not found';
            return void 0 !== g._ctChart ? (f = g._ctChart.attr({
                width: d || '100%',
                height: e || '100%'
            }), f.empty()) : (f = c.svg('svg').attr({
                width: d || '100%',
                height: e || '100%'
            }), g.appendChild(f._node), g._ctChart = f), f;
        }, c.getDataArray = function (a) {
            for (var b = [], c = 0; c < a.series.length; c++)
                b[c] = 'object' == typeof a.series[c] && void 0 !== a.series[c].data ? a.series[c].data : a.series[c];
            return b;
            ...
            return f;
        }, c.interpolateData = function (a, b, c) {
            ...
            b.labels.forEach(function (g, h) {
                ...
                if ((i || 0 === i) && (f.axisX.showGrid && d.elem('line', {
                        ...
                        f.classNames.grid,
                        f.classNames.horizontal
                    ].join(' ')), f.axisX.showLabel)) {
                    var k = e.elem('text', { dx: j + 2 }, [
                            f.classNames.label,
                            f.classNames.horizontal
                        ].join(' ')).text('' + i);
            ...
            b.values.forEach(function (g, h) {
                ...
                (i || 0 === i) && (f.axisY.showGrid && c.elem('line', {
                    ...
                    f.classNames.grid,
                    f.classNames.vertical
                ].join(' ')), f.axisY.showLabel && d.elem('text', {
            ...
            return {
                x: a.x1 + a.width() / c.length * d,
                y: a.y1 - a.height() * (c[d] - b.min) / (b.range + b.step)
            };
        }, c.optionsProvider = function (b, d, e, f) {
            function g() {
                if (h = c.extend({}, j), e)
            ...
            var h, i, j = c.extend(c.extend({}, b), d), k = [];
            if (!a.matchMedia)
                throw 'window.matchMedia not found! Make sure you\'re using a polyfill.';
            if (e)
                for (i = 0; i < e.length; i++) {
                    var l = a.matchMedia(e[i][0]);
                    l.addListener(g), k.push(l);
                }
            return g();
        ...
        c.svg = function (a, d, e, f) {
            ...
            function h(a, c, d, e, f) {
                var h = b.createElementNS(o, c);
                return h._ctSvgElement = a, f && f.appendChild(h), d && g(h, d), e && m(h, e), h;
            }
            function i(a, c) {
            ...
            function m(a, b) {
                a.setAttribute('class', l(a).concat(b.trim().split(/\s+/)).filter(function (a, b, c) {
                    return c.indexOf(a) === b;
                }).join(' '));
            }
            function n(a, b) {
                var c = b.trim().split(/\s+/);
                a.setAttribute('class', l(a).filter(function (a) {
                    return -1 === c.indexOf(a);
                }).join(' '));
            }
            var o = 'http://www.w3.org/2000/svg';
            return {
                _node: h(this, a, d, e, f ? f._node : void 0),
                _parent: f,
                parent: function () {
                    return this._parent;
                },
                attr: function (a) {
                    return g(this._node, a), this;
                },
                empty: function () {
                    return j(this._node), this;
                },
                remove: function () {
                    return k(this._node), this;
                },
                elem: function (a, b, d) {
                    return c.svg(a, b, d, this);
                },
                text: function (a) {
                    return i(this._node, a), this;
                },
                addClass: function (a) {
                    return m(this._node, a), this;
                },
        ...
        c.Line = function (b, d, e, f) {
            function g(a) {
                var e, f, g, h = [], j = c.normalizeDataArray(c.getDataArray(d), d.labels.length);
                i = c.createSvg(b, a.width, a.height), g = c.getBounds(i, j, a), e = a.axisX.offset, a.axisX.showLabel && (e += c.calculateLabelOffset(i, d.labels, [
                    a.classNames.label,
                    a.classNames.horizontal
                ].join(' '), a.axisX.labelInterpolationFnc, c.getHeight)), f = a.axisY.offset, a.axisY.showLabel && (f += c.calculateLabelOffset(i, g.values, [
                    a.classNames.label,
                    a.classNames.horizontal
                ].join(' '), a.axisY.labelInterpolationFnc, c.getWidth));
                var k = c.createChartRect(i, a, e, f), l = i.elem('g'), m = i.elem('g');
                c.createXAxis(k, d, m, l, a), c.createYAxis(k, g, m, l, f, a);
                for (var n = 0; n < d.series.length; n++) {
                    h[n] = i.elem('g'), h[n].addClass([
                        a.classNames.series,
                        d.series[n].className || a.classNames.series + '-' + c.alphaNumerate(n)
                    ].join(' '));
                    var o, p = c.projectPoint(k, g, j[n], 0), q = [
                            p.x,
                            p.y
                        ];
                    a.showPoint && (o = h[n].elem('line', {
                        x1: p.x,
                        y1: p.y,
                        x2: p.x + 0.01,
                        y2: p.y
                    }, a.classNames.point));
                    for (var r = 1; r < j[n].length; r++)
                        p = c.projectPoint(k, g, j[n], r), q.push(p.x, p.y), a.showPoint && (o = h[n].elem('line', {
                            x1: p.x,
                            y1: p.y,
                            x2: p.x + 0.01,
                            y2: p.y
                    ...
                    if (a.showLine) {
                        var s = 'M' + q[0] + ',' + q[1] + ' ';
                        if (a.lineSmooth && q.length > 4)
                            for (var t = c.catmullRom2bezier(q), u = 0; u < t.length; u++)
                                s += 'C' + t[u].join();
                        else
                            for (var v = 3; v < q.length; v += 2)
                                s += 'L ' + q[v - 1] + ',' + q[v];
                        h[n].elem('path', { d: s }, a.classNames.line);
                    }
                }
            }
            var h, i, j = {
            ...
            return h = c.optionsProvider(j, e, f, function (a) {
                h = a, g(h);
        ...
        c.Bar = function (b, d, e, f) {
            function g(a) {
                var e, f, g, h = [], j = c.normalizeDataArray(c.getDataArray(d), d.labels.length);
                i = c.createSvg(b, a.width, a.height), g = c.getBounds(i, j, a, 0), e = a.axisX.offset, a.axisX.showLabel && (e += c.calculateLabelOffset(i, d.labels, [
                    a.classNames.label,
                    a.classNames.horizontal
                ].join(' '), a.axisX.labelInterpolationFnc, c.getHeight)), f = a.axisY.offset, a.axisY.showLabel && (f += c.calculateLabelOffset(i, g.values, [
                    a.classNames.label,
                ...
                var k = c.createChartRect(i, a, e, f), l = i.elem('g'), m = i.elem('g'), n = c.projectPoint(k, g, [0], 0);
                c.createXAxis(k, d, m, l, a), c.createYAxis(k, g, m, l, f, a);
                for (var o = 0; o < d.series.length; o++) {
                    var p = o - (d.series.length - 1) / 2, q = k.width() / j[o].length / 2;
                    h[o] = i.elem('g'), h[o].addClass([
                        a.classNames.series,
                        d.series[o].className || a.classNames.series + '-' + c.alphaNumerate(o)
                    ].join(' '));
                    for (var r = 0; r < j[o].length; r++) {
                        var s, t = c.projectPoint(k, g, j[o], r);
                        t.x += q + p * a.seriesBarDistance, s = h[o].elem('line', {
                            x1: t.x,
                            y1: n.y,
                            x2: t.x,
                            y2: t.y
                        }, a.classNames.bar + (d.series[o].barClasses ? ' ' + d.series[o].barClasses : ''));
                    }
                }
            }
            var h, i, j = {
        ...
        c.Pie = function (b, d, e, f) {
            function g(a) {
                var e, f, g, h = [], j = a.startAngle, k = c.getDataArray(d);
                i = c.createSvg(b, a.width, a.height), e = c.createChartRect(i, a, 0, 0), f = Math.min(e.width() / 2, e.height() / 2), g = a.total || k.reduce(function (a, b) {
                    return a + b;
                }, 0), f -= a.donut ? a.donutWidth / 2 : 0;
                for (var l = {
                            x: e.x1 + e.width() / 2,
                            y: e.y2 + e.height() / 2
                        }, m = 0; m < d.series.length; m++) {
                    h[m] = i.elem('g'), h[m].addClass([
                        a.classNames.series,
                        d.series[m].className || a.classNames.series + '-' + c.alphaNumerate(m)
                    ].join(' '));
                    var n = j + k[m] / g * 360;
                    n - j === 360 && (n -= 0.01);
                    var o = c.polarToCartesian(l.x, l.y, f, j - (0 === m ? 0 : 0.2)), p = c.polarToCartesian(l.x, l.y, f, n), q = 180 >= n - j ? '0' : '1', r = [
                            'M',
                            p.x,
                            p.y,
                            'A',
                    ...
                    a.donut === !1 && r.push('L', l.x, l.y);
                    var s = h[m].elem('path', { d: r.join(' ') }, a.classNames.slice + (a.donut ? ' ' + a.classNames.donut : ''));
                    a.donut === !0 && s.attr({ style: 'stroke-width: ' + +a.donutWidth + 'px' }), j = n;
                }
            }
            var h, i, j = {
                    width: void 0,
...
(function () {
    ...
    define('views/statistics_view', [
        'jquery',
        'backbone',
        'services/statistic_service',
        'services/key_converter',
        'Chartist'
    ], function ($, Backbone, StatisticService, KeyConverter, Chartist) {
        var StatisticsView;
...
(function () {
    ...
    define('views/main_view', [
    ...
    ], function ($, Backbone, Vex, MidiService, StatisticService, KeyConverter, StatisticsView) {
        var MainView;
        return MainView = function (_super) {
                    ...
                    _results.push(clef.forEach(function (_this) {
                        return function (staveNote, index) {
                            ...
                            for (index = _i = 0, _ref1 = staveNote.getKeys().length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; index = 0 <= _ref1 ? ++_i : --_i) {
                                _results1.push(staveNote.setKeyStyle(index, { fillStyle: color }));
                            }
                            return _results1;
                        };
                    }(this)));
            ...
            MainView.prototype.generateBar = function (clef) {
                ...
                baseModifiers = options.withModifiers ? [
                    '',
                    'b',
                    '#'
                ] : [''];
...
(function () {
    ...
    define('router', [
        ...
        'lib/uber_router',
        'views/main_view'
    ], function ($, Backbone, UberRouter, MainView) {
        var Router;
