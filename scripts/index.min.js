    ...
    return a.version = '0.1.14', function (a, b, c) {
        ...
        c.xmlNs = {
            ...
            function h(a, b, d) {
                return Object.keys(b).forEach(function (e) {
                    d ? a.setAttributeNS(d, [
                        c.xmlNs.prefix,
                        ':',
                        e
                    ].join(''), b[e]) : a.setAttribute(e, b[e]);
                }), a;
            }
            ...
            return {
                _node: i(this, a, d, e, f, g ? g._node : void 0),
                _parent: g,
                parent: function () {
                    return this._parent;
                },
        ...
        c.Line = function (b, d, e, f) {
            function g(a) {
                ...
                n = c.createSvg(p, a.width, a.height, a.classNames.chart), f = c.getBounds(n, h, a), b = a.axisX.offset, a.axisX.showLabel && (b += c.calculateLabelOffset(n, d.labels, [
                    a.classNames.label,
                    a.classNames.horizontal
                ].join(' '), a.axisX.labelInterpolationFnc, c.getHeight)), e = a.axisY.offset, a.axisY.showLabel && (e += c.calculateLabelOffset(n, f.values, [
                    a.classNames.label,
                    a.classNames.horizontal
                ...
                for (var l = 0; l < d.series.length; l++) {
                    g[l] = n.elem('g'), d.series[l].name && g[l].attr({ 'series-name': d.series[l].name }, c.xmlNs.uri), g[l].addClass([
                        a.classNames.series,
                        d.series[l].className || a.classNames.series + '-' + c.alphaNumerate(l)
                    ].join(' '));
                    for (var m, o, q = [], r = 0; r < h[l].length; r++)
                        m = c.projectPoint(i, f, h[l], r), q.push(m.x, m.y), a.showPoint && (o = g[l].elem('line', {
                            x1: m.x,
                            y1: m.y,
                            x2: m.x + 0.01,
                            y2: m.y
            ...
            var q = {
                    ...
                    update: h,
                    detach: i,
                    addOptionsListener: j,
                    removeOptionsListener: k
                };
        ...
        c.Bar = function (b, d, e, f) {
            function g(a) {
                var b, e, f, g = [], h = c.normalizeDataArray(c.getDataArray(d), d.labels.length);
                m = c.createSvg(o, a.width, a.height, a.classNames.chart), f = c.getBounds(m, h, a, 0), b = a.axisX.offset, a.axisX.showLabel && (b += c.calculateLabelOffset(m, d.labels, [
                    a.classNames.label,
                    a.classNames.horizontal
                ].join(' '), a.axisX.labelInterpolationFnc, c.getHeight)), e = a.axisY.offset, a.axisY.showLabel && (e += c.calculateLabelOffset(m, f.values, [
                    a.classNames.label,
                    a.classNames.horizontal
                ].join(' '), a.axisY.labelInterpolationFnc, c.getWidth));
                ...
                for (var n = 0; n < d.series.length; n++) {
                    ...
                    g[n] = m.elem('g'), d.series[n].name && g[n].attr({ 'series-name': d.series[n].name }, c.xmlNs.uri), g[n].addClass([
                        a.classNames.series,
        ...
        c.Pie = function (b, d, e, f) {
            ...
            function h(a) {
                ...
                for (var l = {
                    ...
                    i[m] = o.elem('g', null, null, !0), d.series[m].name && i[m].attr({ 'series-name': d.series[m].name }, c.xmlNs.uri), i[m].addClass([
                        a.classNames.series,
                        d.series[m].className || a.classNames.series + '-' + c.alphaNumerate(m)
                    ].join(' '));
                    var n = j + k[m] / h * 360;
                    n - j === 360 && (n -= 0.01);
                    var p = c.polarToCartesian(l.x, l.y, e, j - (0 === m ? 0 : 0.2)), r = c.polarToCartesian(l.x, l.y, e, n), s = 180 >= n - j ? '0' : '1', t = [
                            'M',
                            r.x,
                            r.y,
                            'A',
            ...
            var r = {
                    ...
                    update: i,
                    detach: j,
                    addOptionsListener: k,
                    removeOptionsListener: l
                };
